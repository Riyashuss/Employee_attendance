											...
											<div class="row mt-2">
												...
												<div class="col-lg-6">
													<div class="input-group">
														<input id="inWorkOrderName" name="inWorkOrderName" class="form-control rounded" type="text" readonly value="{{ auth()->user()->username }}"/>
													</div>
													@error('name')
											...
											<div class="row mt-4">
												...
												<div class="col-sm-4">
													<div class="input-group">
														...
														@else
															<input type="hidden" name="location" value="{{ $existingAttendance->location_id }}"/>
															<input id="location_display" name="location_display" class="form-control rounded" type="text" readonly value="{{ $existingAttendance->location_name }}"/>
														@endif
													</div>
												</div>
											</div>
												...
												<div class="col-lg-10 d-flex justify-content-center">
													...
													@if (!$existingAttendance || !$existingAttendance->checkout)
														<button 
															...
															type="button" 
															class="btn {{ $existingAttendance && !$existingAttendance->checkout ? 'btn-danger' : 'btn-success' }}"
															data-status="{{ $existingAttendance && !$existingAttendance->checkout ? 'checkout' : 'checkin' }}">
															{{ $existingAttendance && !$existingAttendance->checkout ? 'Check Out' : 'Check In' }}
														</button>
													@else
