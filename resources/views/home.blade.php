...
<div class="ps__rail-x" style="left: 0px; bottom: 0px;"><div class="ps__thumb-x" tabindex="0" style="left: 0px; width: 0px;"></div></div><div class="ps__rail-y" style="top: 0px; right: 0px;"><div class="ps__thumb-y" tabindex="0" style="top: 0px; height: 0px;"></div></div></aside>
    ...
    <p class="text-dark text-center">Date: {{ now()->format('Y-m-d') }}</p>
...
<!-- Container to manage responsiveness -->
    ...
    <div style="display: flex; align-items: center; margin: 3px;">
        ...
        <span style="margin-left: 10px;">{{ $userCount }}</span>
    </div>
    ...
    <div style="display: flex; align-items: center; margin: 3px;">
        ...
        <span style="margin-left: 10px;">{{ $presentCount }}</span>
    </div>

    <div style="display: flex; align-items: center; margin: 3px;">
        <span style="padding-left: 325px;">Leave</span>
        <span style="padding-left: 10px;">:</span>
        <span style="margin-left: 10px;">{{ $absentCount }}</span>
    </div>
    </div>
                <a href="{{ route('projectDetailsPage1') }}" class="btn btn-dark btn-sm" 
    ...
    <!-- Project Card -->
            <div class="p-3 text-white text-left" 
                ...
                <p class="text-dark text-center">Total Projects: {{ $totalProjects }}</p>
                <p class="text-dark text-center">Current Projects: {{ $currentCount > 0 ? $currentCount : 'No current projects available.' }}</p>
                <p class="text-dark text-center">Completed Projects: {{ $completedCount > 0 ? $completedCount : 'No completed projects available.' }}</p>
            
                <a href="{{ route('projectDetailsPage') }}" class="btn btn-dark btn-sm text-center" 
                style=" max-width:70%;margin:auto;">More..</a>
