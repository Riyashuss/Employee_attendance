    ...
    <div class="card shadow-lg w-75">
        <div class="card-body">
            ...
            <h5 class="text-center" style="color:rgb(255, 87, 51);">
                <strong>Username:</strong> {{ $userDetails->first()->username }}
            </h5>
            ...
            <div class="mt-4">
                ...
                @if ($groupedProjects->isNotEmpty())
                    <ul class="list-group list-group-flush">
                        @foreach ($groupedProjects as $projectName => $tasks)
            ...
            <div class="text-center mt-4">
                <a href="{{ url()->previous() }}" class="btn btn-secondary px-4 py-2 shadow-sm">
