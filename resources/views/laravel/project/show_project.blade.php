                ...
                <table class="table" id="workOrderTable">
                    ...
                    <tbody>
                        @foreach ($projects as $project)
                            <tr>
                                <td class="text-sm font-weight-normal text-center">{{ $project->project_name }}</td>
                                <td class="text-center">
                                <button class="btn btn-icon btn-2  mb-0 me-1"style="background-color:#57A6A1;"  type="button" onclick="viewproject('{{ $project->id }}')">

                                    <span class="btn-inner--icon"style="color:white;"><i class="fa fa-eye"></i> </span>
                                    <!-- <button class="btn btn-view bg-success" onclick="viewproject('{{ $project->id }}')"> -->
                                        <!-- <i class="fa fa-eye"></i> View -->
                                    </button>
                              
                                <button style="background-color:#004A67;" class="btn btn-icon btn-2 btn-info mb-0 me-1" type="button" onclick="editProject('{{ $project->id }}', '{{ $project->project_name }}')">
                                    <!-- <button class="btn btn-edit bg-info" onclick="editProject('{{ $project->id }}', '{{ $project->project_name }}')">-->
                                        <i class="fa fa-pencil"></i> 
                                    </button>
                               
                                <button class="btn btn-icon btn-2 btn-danger mb-0 me-1" type="button" onclick="deleteProject('{{ $project->id }}', '{{ $project->project_name }}')">
                                    <span class="btn-inner--icon"><i class="fa fa-trash"></i> </span>
                                <!-- </button>
                                    <button class="btn btn-delete bg-warning" onclick="deleteProject('{{ $project->id }}', '{{ $project->project_name }}')">
