...
<div class="ps__rail-x" style="left: 0px; bottom: 0px;"><div class="ps__thumb-x" tabindex="0" style="left: 0px; width: 0px;"></div></div><div class="ps__rail-y" style="top: 0px; right: 0px;"><div class="ps__thumb-y" tabindex="0" style="top: 0px; height: 0px;"></div></div></aside>
    ...
    <div class="card text-center" id="basic-info" style="width:90%; margin:auto;">
            ...
            @php $groupedProjects = $projects->groupBy('project_name'); @endphp <!-- Group projects by name -->
    ...
    @foreach($groupedProjects as $projectName => $tasks)
        <div class="project-section p-3 bg-white text-dark" style="border-radius: 10px; margin-bottom: 15px;">
            ...
            <p class="text-center">
                <strong>{{ $tasks->first()->project_code }}:</strong> {{ $projectName }}
                </p>
                <button class="btn btn-primary btn-sm show-tasks-btn" data-target="#tasks-{{ Str::slug($projectName) }}">Show</button>
           
            <!-- Collapsible Task List -->
            <div id="tasks-{{ Str::slug($projectName) }}" class="scrollable-project-content collapse mt-3">
                @foreach($tasks as $task)
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        ...
                        <div class="d-flex align-items-center gap-2 w-50">
                            <p><strong></strong> {{ $task->username ?? 'No user assigned' }}</p>
                        </div>
                    </div>
                @endforeach
            </div>
