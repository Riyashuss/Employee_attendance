                ...
                <div class="card-body pt-0">
                    ...
                    <div class="row">
                        <div class="col-6">
                            ...
                            <input id="employeename" name="employeename" class="form-control" type="text" placeholder="Employee Name" value="{{ old('employeename', $user->username) }}" readonly>
                        </div>

                        <div class="col-6">
                            <label class="form-label">Password</label>
                            <input id="password" name="password" class="form-control" type="password" placeholder="Leave blank to keep the same" value="{{ old('password', $user->password) }}" readonly>
                        </div>
                    </div>
                    ...
                    <div class="row mt-4">
                        <div class="col-6">
                            ...
                            <input id="joindate" name="joindate" class="form-control" type="date" value="{{ old('joindate', $user->joiningdate) }}" readonly>
                        </div>

                        <div class="col-6">
                            <label class="form-label">Employee Id</label>
                            <input id="employee_id" name="employee_id" class="form-control" type="text" placeholder="Employee Id" value="{{ old('employee_id', $user->emp_id) }}" readonly>
                        </div>
                    </div>
                    ...
                    <div class="mt-4">
                        ...
                        <select name="role" id="choices-role" class="form-control" disabled>
                            ...
                            <option value="2" {{ old('role', $user->role_id) == '2' ? 'selected' : '' }}>Employee</option>
                        </select>
                    </div>
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-6">
                            ...
                            <input id="birthday" name="birthday" class="form-control" type="date" value="{{ old('birthday', $user->dob) }}" readonly>
                        </div>
                    </div>
                    ...
                    <div class="row mt-4">
                        <div class="col-6">
                            ...
                            <input id="email" name="email" class="form-control" type="email" value="{{ old('email', $user->mail) }}" readonly>
                        </div>

                        <div class="col-6">
                            <label class="form-label">Blood Group</label>
                            <input id="bloodgroup" name="bloodgroup" class="form-control" type="text" value="{{ old('bloodgroup', $user->bloodgroup) }}" readonly>
                        </div>
                    </div>
                    ...
                    <div class="row mt-4">
                        <div class="col-6">
                            ...
                            <input id="address" name="address" class="form-control" type="text" value="{{ old('address', $user->address) }}" placeholder="Address" readonly>
                        </div>

                        <div class="col-6">
                            <label class="form-label">Phone Number</label>
                            <input id="phone" name="phone" class="form-control" type="text" value="{{ old('phone', $user->contact) }}" placeholder="+40 735 631 620" readonly>
                        </div>
                    </div>
