    ...
    @method('PUT')
                    ...
                    <div class="row">
                        <div class="col-6">
                            ...
                            <input id="username" name="username" class="form-control" type="text" placeholder="Employee Name" value="{{ old('username', $user->username) }}" required>
                            @error('username')
                        ...
                        <div class="col-6">
                            ...
                            <input id="password" name="password" class="form-control" type="password" placeholder="Leave blank to keep the same" value="{{ old('password', $user->password) }}">
                        </div>
                    </div>
                    ...
                    <div class="row mt-4">
                        <div class="col-6">
                            ...
                            <input id="joiningdate" name="joiningdate" class="form-control" type="date" value="{{ old('joindate', $user->joiningdate) }}" required>
                            @error('joindate')
                                <p class='text-danger text-xs pt-1'>{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="col-6">
                            ...
                            <input id="emp_id" name="emp_id" class="form-control" type="text" placeholder="Employee Id" value="{{ old('employee_id', $user->emp_id) }}" required>
                            @error('employee_id')
                                <p class='text-danger text-xs pt-1'>{{ $message }}</p>
                            @enderror
                        </div>
    ...
    <div class="col-6">-->
        ...
        <div>
            @foreach($roles as $role)
                ...
                <input class="form-check-input" type="checkbox" name="role_id[]" value="{{ $role->id }}" id="role_{{ $role->id }}" {{ in_array($role->id, $assignedRoles) ? 'checked' : '' }}>
	...
	<div class="row mt-1 ps-3 pe-3">
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-6">
                            ...
                            <input id="dob" name="dob" class="form-control" type="date" value="{{ old('birthday', $user->dob) }}" required>
                            @error('birthday')
                                <p class='text-danger text-xs pt-1'>{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="row mt-4">
                        <div class="col-6">
                            ...
                            <input id="mail" name="mail" class="form-control" type="email" value="{{ old('mail', $user->mail) }}" required>
                            @error('email')
                                <p class='text-danger text-xs pt-1'>{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="col-6">
                            ...
                            <input id="bloodgroup" name="bloodgroup" class="form-control" type="text" value="{{ old('bloodgroup', $user->bloodgroup) }}" required>
                            @error('bloodgroup')
                                <p class='text-danger text-xs pt-1'>{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="row mt-4">
                        <div class="col-6">
                            ...
                            <input id="address" name="address" class="form-control" type="text" value="{{ old('address', $user->address) }}" placeholder="Address" required>
                        </div>

                        <div class="col-6">
                            <label class="form-label">Phone Number</label>
                            <input id="contact" name="contact" class="form-control" type="text" value="{{ old('phone', $user->contact) }}" placeholder="+40 735 631 620">
                            @error('phone')
                                <p class='text-danger text-xs pt-1'>{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="d-flex justify-content-end mt-4">
                        <a href="{{ route('user_details') }}" class="btn btn-light m-0">Back</a>
