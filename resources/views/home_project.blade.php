...
<div class="card-body" >
   <div class="container">
       ...
       <div class="card" id="basic-info"style="max-width: 80%; margin:auto; padding: 10px;">
               ...
               @php $lastProjectName = null; @endphp
               @foreach($projects as $project)
                   @if($lastProjectName !== $project->project_name)
                       ...
                       <div class="p-3 bg-light text-dark mb-3 project-item" 
                           ...
                           <div class="d-flex justify-content-between align-items-center flex-wrap">
                               <p class="mb-1"><strong>Project: </strong>{{ $project->project_name }}</p>
                       ...
                       @php $lastProjectName = $project->project_name; @endphp
                   @endif
               @endforeach
           </div>
       </div>
...
<div class="task-row" style="display: flex; align-items: center; margin: 2px;">
    ...
    <div class="task" style=" min-width:50%;text-align: left;">
        <strong>Task:</strong>{{ $project->task_name }}
    </div>
    <div class="status" style="min-width: 50%; text-align: center;">
        <strong>Status:</strong> {{ $project->status == 2 ? 'Completed' : ($project->status == 1 ? 'In Progress' : 'Not Started') }}
    </div>
</div>
                ...
                @if ($project->status == 1)
                    ...
                    <button class="btn btn-sm btn-info"
                            ...
                            data-task-name="{{ $project->task_name }}">
                        Update
                    </button>
