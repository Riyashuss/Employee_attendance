                    ...
                    <thead class=" text-white"style="background-color:#C48264;" >
                        ...
                        <th class="text-sm text-center">Employee</th>
                           ...
                           <!-- <th class="text-sm text-center">Project-Task</th>
                            ...
                            <th class="text-sm text-center">@lang('words.action')</th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <tr>
                        <td>
                                <button style="background-color:#004A67;" class="btn btn-icon btn-2 btn-info mb-0 me-1" type="button" onclick="edituserdetails({{ $Userdetail->id }})">
                                <span class="btn-inner--icon"><i class="fa fa-user"></i> </span>
                                </button>
                            </td>
                            <td class="text-sm text-center font-weight-normal">{{ $Userdetail->uname }}</td>
                            <td class="text-sm text-center font-weight-normal">{{ $Userdetail->mail }}</td>
                           
                            <td class="text-sm text-center font-weight-normal">
                                <button class="btn btn-icon btn-2  mb-0 me-1"style="background-color:#57A6A1;"  type="button"onclick="viewUser({{ $Userdetail->id }})"
>
                                    <span class="btn-inner--icon"style="color:white;"><i class="fa fa-eye"></i> </span>
                                </button>
                                <button style="background-color:#004A67;" class="btn btn-icon btn-2 btn-info mb-0 me-1" type="button" onclick="edituser({{ $Userdetail->id }})">
                                    <span class="btn-inner--icon"><i class="fa fa-edit"></i> </span>
                                </button>
                                <button class="btn btn-icon btn-2 btn-danger mb-0 me-1" type="button" onclick=" updateuserAction({{$Userdetail->id}})">
    ...
    <div id="noDataMessage" class="container justify-content-center text-center" style="display: none;">
        @lang('words.nomatchingresultsfound')
    </div>
...
function updateuserAction(user_id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            $.ajax({
                url: '{{ route('update-user-action') }}', // Ensure the route is correct
                type: 'POST',
                data: {
                    user_id: user_id,
