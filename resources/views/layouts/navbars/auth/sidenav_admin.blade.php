    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-2 fixed-start ms-2 bg-default {{ $box ?? '' }}"
    id="sidenav-main">
    ...
    <!-- <div class="sidenav-header" style="background-color:#338E8C; position: relative;">
        ...
        <!-- <span class="toggle-btn" id="toggleBtn">☰</span> -->
            <!-- <img src="{{ $logo ?? '/assets/img/logo.png'}}" class="navbar-brand-img" alt="main_logo"> -->
    ...
    <div class="sidenav " id="sidenav">
        ...
        <ul class="navbar-nav" >
            <li class="nav-item"  id="ddd1">
                ...
                <a href="{{ route('home') }}" 
                class="nav-link {{ Route::currentRouteName() == 'dashboard' ? 'active' : '' }}" href=""
            ...
            <li class="nav-item" id="ddd">
                ...
                class="nav-link {{ Route::currentRouteName() == 'dashboard' ? 'active' : '' }}" href=""
                    ...
                    <span class="nav-link-text ms-1">@lang('words.db')</span>
                </a>               
            </li>
            ...
            <li class="nav-item sidemenuitem " id="menuUsers" style="display:none;">
                ...
                class="nav-link {{ Route::currentRouteName() == 'users' ? 'active' : '' }}" href=""
            ...
            <li class="nav-item sidemenuitem" id="menuAttendance" style="display:none;">
                <a href="{{ route('home_attendance') }}" 
                class="nav-link {{ Route::currentRouteName() == 'attendance' ? 'active' : '' }}" href=""
            ...
            <li class="nav-item sidemenuitem" id="menuProject" style="display:none;">
                ...
                class="nav-link {{ Route::currentRouteName() == 'Project' ? 'active' : '' }}" href=""
            ...
            <li class="nav-item sidemenuitem" id="details" style="display:none;">
                ...
                class="nav-link {{ Route::currentRouteName() == 'details' ? 'active' : '' }}" href=""
                ...
                <div class="collapse show" id="details">
                    <ul class="nav ms-4">
                        <li class="nav-item ">
                            <a class="nav-link {{ Route::currentRouteName() == 'createdetails' ? 'active' : '' }}" href="{{ route('user_details') }}">
                                <div class="icon icon-shape icon-sm text-center d-flex align-items-end justify-content-center">
                ...
                <div class="collapse show" id="details">
                    <ul class="nav ms-4">
                        <li class="nav-item ">
                            <a class="nav-link {{ Route::currentRouteName() == 'projectview' ? 'active' : '' }}" href="{{ route('projectview') }}">
                                <div class="icon icon-shape icon-sm text-center d-flex align-items-end justify-content-center">
                                    <!-- <i class="fa fa-file-pen text-sm opacity-10" style="color: #00FFFF;"></i> -->
                                </div>
