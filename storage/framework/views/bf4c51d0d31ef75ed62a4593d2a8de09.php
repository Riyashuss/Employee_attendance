        ...
        <div class="card-body mt-5">
            ...
            <div class="table-responsive">
                <table class="table" id="workOrderTable">
                    <thead>
                        <tr>
                            <th class="text-sm text-center">Project Name</th>
                            <th class="text-sm text-center"style="text-allign:center;">Action</th>
                    ...
                    <tbody>
                        <?php $__currentLoopData = $projects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $project): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td class="text-sm font-weight-normal text-center"><?php echo e($project->project_name); ?></td>
                                <td class="text-center">
                                <button class="btn btn-icon btn-2  mb-0 me-1"style="background-color:#57A6A1;"  type="button" onclick="viewproject('<?php echo e($project->id); ?>')">

                                    <span class="btn-inner--icon"style="color:white;"><i class="fa fa-eye"></i> </span>
                                    <!-- <button class="btn btn-view bg-success" onclick="viewproject('<?php echo e($project->id); ?>')"> -->
                                        <!-- <i class="fa fa-eye"></i> View -->
                                    </button>
                              
                                <button style="background-color:#004A67;" class="btn btn-icon btn-2 btn-info mb-0 me-1" type="button" onclick="editProject('<?php echo e($project->id); ?>', '<?php echo e($project->project_name); ?>')">
                                    <!-- <button class="btn btn-edit bg-info" onclick="editProject('<?php echo e($project->id); ?>', '<?php echo e($project->project_name); ?>')">-->
                                        <i class="fa fa-pencil"></i> 
                                    </button>
                               
                                <button class="btn btn-icon btn-2 btn-danger mb-0 me-1" type="button" onclick="deleteProject('<?php echo e($project->id); ?>', '<?php echo e($project->project_name); ?>')">
                                    <span class="btn-inner--icon"><i class="fa fa-trash"></i> </span>
                                <!-- </button>
                                    <button class="btn btn-delete bg-warning" onclick="deleteProject('<?php echo e($project->id); ?>', '<?php echo e($project->project_name); ?>')">
...
</html><?php /**PATH C:\xampp\htdocs\Nilatech_attendance\resources\views/laravel/project/show_project.blade.php ENDPATH**/ ?>