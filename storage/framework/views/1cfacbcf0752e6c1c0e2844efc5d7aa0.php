							...
							<div class="row mt-2">
								...
								<div class="col-lg-6">
									<div class="input-group">
										<input id="inWorkOrderName" name="inWorkOrderName" class="form-control rounded" type="text" readonly placeholder="WorkOrder Name" value="<?php echo e($workOrder->name); ?>"/>
...
unset($__errorArgs, $__bag); ?>
								...
								<div class="row mt-4">															
									...
									<div class="col-lg-6">
										<div class="col-lg-4">
											<button id="btnAssignToUser" onclick="assignToUser();" type="button" class="btn btn-success m-0 ms-2">Assign To User</button>
										</div>
									</div>
								</div>
...
<?php $__env->startPush('js'); ?>
	...
	function assignToUser()
	{
		...
		{
			$('#user_name_error').html('User Name should not be empty');
				...
				success: function(response){
					...
					if (response.success)
					{
						Swal.fire({
									icon: 'success',
									title: 'WorkOrder',
									text: "WorkOrder is assigned to : " + assignedToUserName,
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Senthil\DK3\HemmingerUAT\release01_UAT_27042024\dk3app\resources\views/laravel/workorder/assigntouserpreproduction.blade.php ENDPATH**/ ?>