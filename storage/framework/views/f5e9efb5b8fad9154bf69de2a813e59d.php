								...
								<td class="text-sm text-center font-weight-normal text-middle">
									...
									<button class='btn btn-icon btn-2 btn-success mb-0 me-1' type='button' onclick='processClick("<?php echo e($workOrder->workorderid); ?>","<?php echo e($workOrder->status_code); ?>");'>
										<span class='btn-inner--icon'><i class='fa fa-edit'></i>
											...
											<?php elseif($workOrder->status_code == '302'): ?>  <?php echo 'Assign to Qc'; ?>
											<?php elseif($workOrder->status_code == '303'): ?>  <?php echo 'Assign to Model Creation'; ?>
											<?php elseif($workOrder->status_code == '312'): ?>  <?php echo 'Restart Mapcreation'; ?>
											<?php endif; ?>
										</span>
									</button>
									<?php endif; ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\dk3app\resources\views/home_mapcreation.blade.php ENDPATH**/ ?>