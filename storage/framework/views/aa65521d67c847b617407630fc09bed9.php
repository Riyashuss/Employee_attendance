	...
	function processClick(workOrderId,status_code)
	{
	   ...
	   else if (status_code=="201")
	   {
		 Swal.fire({
				icon: 'warning',
				title: 'WorkOrder',
				text: "Please confirm to start Survey. Files for survey will be downloaded automatically.",
		...
		$.ajax({
			...
			success: function(response){
				...
				if (response.success)
				{
					...
					startSurvey(workOrderId);
					//alert(response.basemap_path + "," + response.surveymap_path);
				}
				else
				{
					Swal.fire({
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\dk3app\resources\views/home_survey.blade.php ENDPATH**/ ?>