	...
	function assignToUser()
	{
		...
		var workOrderId = $('#inWorkOrderId').val();
			...
			$.ajax({
				...
				url: '<?php echo e(route('assignToUserqcMapCreationPost')); ?>',
				type: 'post',
				data:fd,
				contentType: false,
				processData: false,
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Senthil\Hemminger\Dk3app_Final\dk3app\resources\views/laravel/mapcreation/assigntouserqcmapcreation.blade.php ENDPATH**/ ?>