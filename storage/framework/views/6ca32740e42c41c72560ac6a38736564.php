    ...
    <a class="navbar-brand"style="backgrounds-color:white" href="">
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item" id="ddd">
                <a href="<?php echo e(route('home_user')); ?>" class="nav-link " aria-controls="dashboard" role="button" aria-expanded="false">
                    <div class="icon icon-shape icon-sm text-center d-flex align-items-center justify-content-center">
                        <!-- <i class="fa fa-house text-sm opacity-10" style="color: #FD1717;"></i> -->
                    </div>
            ...
            <li class="nav-item sidemenuitem" id="menuAttendance" style="">
                <a href="<?php echo e(route('home_attendance')); ?> " class="nav-link " aria-controls="attendance" role="button" aria-expanded="false">
                    <div class="icon icon-shape icon-sm text-center d-flex align-items-end justify-content-center">
            ...
            <li class="nav-item sidemenuitem" id="menuProject" style="">
                <a href="<?php echo e(route('home_Project')); ?> " class="nav-link " aria-controls="Project" role="button" aria-expanded="false">
                    <div class="icon icon-shape icon-sm text-center d-flex align-items-end justify-content-center">
            ...
            <li class="nav-item sidemenuitem" id="details" style="display:none;">
                ...
                <div class="collapse show" id="details">
                    <ul class="nav ms-4">
                        <li class="nav-item ">
                            <a class="nav-link " href="<?php echo e(route('user_details')); ?>">
                                <div class="icon icon-shape icon-sm text-center d-flex align-items-end justify-content-center">
                ...
                <div class="collapse show" id="details">
                    <ul class="nav ms-4">
                        <li class="nav-item ">
                            <a class="nav-link " href="<?php echo e(route('projectview')); ?>">
                                <div class="icon icon-shape icon-sm text-center d-flex align-items-end justify-content-center">
                                    <!-- <i class="fa fa-file-pen text-sm opacity-10" style="color: #00FFFF;"></i> -->
                                </div>
...
</html><?php /**PATH C:\xampp\htdocs\Nilatech_attendance\resources\views/home_user.blade.php ENDPATH**/ ?>