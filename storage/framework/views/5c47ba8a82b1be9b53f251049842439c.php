                    ...
                    <div class="card mt-5">
                        ...
                        <div class="card-body">
                            <form role="form" method="POST" action="<?php echo e(route('login.perform')); ?>" class="text-start">
                                ...
                                <div class="mb-3">
                                    <input type="text" name="firstname" value="<?php echo e(old('firstname') ?? 'Admin'); ?>" class="form-control" placeholder="firstname" aria-label="firstname">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\dk3app\resources\views/auth/login_admin.blade.php ENDPATH**/ ?>