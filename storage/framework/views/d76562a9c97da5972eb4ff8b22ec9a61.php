...
<?php $__env->startSection('content'); ?>
	<nav class="navbar navbar-main navbar-expand-lg px-0 mx-1 shadow-none border-radius-xl mt-2 bg-primary ">
        <div class="container-fluid py-1 px-3">
            <?php echo $__env->make('layouts.navbars.auth.topnav', ['title' => trans('words.objectdata')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
		...
		<div class="card-body pt-1">
			<div class="row mt-2">		
				<div class="col-lg-2  mt-1 text-end">
					<label class="form-label"><?php echo app('translator')->get('words.objectname'); ?></label>
				</div>
				<div class="col-lg-4 ">
					<div>
				...
				<div class="col-lg-2" id="btnAddNewField">
					<div class="me-1">
						<button class="btn btn-icon5 btn-info" type="button" onclick="addField();">
							...
							<span class="btn-inner--text ms-1"><?php echo app('translator')->get('words.addnewfield'); ?></span>
						</button>						
					</div>			
				</div>
				<div class="col-lg-2 text-end">
					<div class="me-1">
						<button class="btn btn-icon5 btn-success" type="button" onclick="addObjectTable();">
							...
							<span class="btn-inner--text ms-1"><?php echo app('translator')->get('words.uploadtemplate'); ?></span>
						</button>						
					</div>			
				</div>
				<div class="col-lg-2">
					<div class="me-1">
						<button class="btn btn-icon5 btn-dark" type="button" onclick="generateTable();">
							...
							<span class="btn-inner--text ms-1"><?php echo app('translator')->get('words.generatetables'); ?></span>
						</button>						
					</div>			
				</div>
				...
				<div class="col-lg-10">
					<div class="card px-3 py-3">
						...
						<div class="row">
							<div class="col-lg-4 ">
								<div class="mt-3">
									<label class="form-label"><?php echo app('translator')->get('words.fieldname'); ?></label>
									<div class="input-group">
										<input id="fieldname" name="fieldname" class="form-control" type="text"
											placeholder="<?php echo app('translator')->get('words.fieldname'); ?>" value="">
									</div>
							...
							<div class="col-lg-4 ">
								<div class="mt-3">
									<label class="form-label"><?php echo app('translator')->get('words.fieldtype'); ?></label>
							...
							<div class="col-lg-4 ">
								<div class="mt-3">
									<label class="form-label"><?php echo app('translator')->get('words.fieldsize'); ?></label>
									<div class="input-group">
										<input id="fieldsize" name="fieldsize" class="form-control" type="text"
											placeholder="<?php echo app('translator')->get('words.fieldsize'); ?>" value="<?php echo e(old('fieldsize')); ?>">
									</div>
						...
						<div class="row">												
							<div class="col-lg-4 ">
								<div class="mt-3">
									<label class="form-label"><?php echo app('translator')->get('words.attributeposition'); ?></label>
									<div class="input-group">
										<input id="attributeposition" name="attributeposition" class="form-control" type="text"
											placeholder="<?php echo app('translator')->get('words.attributeposition'); ?>" value="<?php echo e(old('attributeposition')); ?>">
									</div>
							...
							<div class="col-lg-4 ">
								<div id="reflistrow" class="mt-3">
									<label class="form-label"><?php echo app('translator')->get('words.referencelist'); ?></label>
						...
						<div class="row text-center mt-4">							
							<div class="col-lg-12 mt-2">
								<button id="btnSaveField" onclick="divbtnAddField();" class="btn btn-icon5 btn-success text-white me-2" type="button">
									...
									<span class="btn-inner--text ms-1"><?php echo app('translator')->get('words.add'); ?></span>
								</button>
							...
							<thead class="bg-dark text-white">
								<tr>
									<th class="bg-light-primary text-center">
										<?php echo app('translator')->get('words.fieldname'); ?>
									</th>
									<th class="bg-light-primary text-center">
									<?php echo app('translator')->get('words.fieldtype'); ?>
									</th>
									<!--<th class="bg-light-primary text-center">
										Field Size
									</th>-->
									<th class="bg-light-primary text-center">
										<?php echo app('translator')->get('words.lovreference'); ?>
									</th>
									<th class="bg-light-primary text-center">
										<?php echo app('translator')->get('words.position'); ?>
									</th>
									<th class="bg-light-primary text-center">
...
<?php $__env->startPush('js'); ?>
    ...
    <script>
		...
		function generateTable()
		{
			Swal.fire({
					icon: 'warning',
					title: '<?php echo app('translator')->get('words.objectdata'); ?>',
					text: '<?php echo app('translator')->get('words.pleaseconfirmtocreatethetable'); ?>' ,
							...
							$.ajax({
								...
								success: function(response){					
									...
									if (response.success) {
											Swal.fire({
													icon: 'success',
													title: '<?php echo app('translator')->get('words.objectstructure'); ?>',
													text: '<?php echo app('translator')->get('words.tablegeneratedsuccessfully'); ?>',
		...
		function addField()
		{
			...
			if(objectname == 0)
			{
				$('#objectname_error').html('<?php echo app('translator')->get('words.pleaseselectobjectname'); ?>');
		...
		function divbtnAddField()
		{
			...
			if(fieldname == "")
			{
				$('#fieldname_error').html('<?php echo app('translator')->get('words.fieldnameshldnotemt'); ?>');
			...
			else 
			{
				...
				{				
					$('#fieldname_error').html('<?php echo app('translator')->get('words.fieldnamealreadyexists'); ?>');
					$('#fieldname_error').show();
					isError = true;
				}
			}
			...
			if(fieldtype < 1)
			{
				$('#fieldtype_error').html('<?php echo app('translator')->get('words.pleaseselectfieldtype'); ?>');
			...
			if(fieldsize == "")
			{
				$('#fieldsize_error').html('<?php echo app('translator')->get('words.fieldsizeshldnotemt'); ?>');
			...
			if(position == "")
			{
				$('#position_error').html('<?php echo app('translator')->get('words.attributepositionshldnotemt'); ?>');
				$('#position_error').show();
				isError = true;				
			}
			...
			if($('#fieldtype').val() == 6)
			{
				if(reference == "")
				{
					$('#reflist_error').html('<?php echo app('translator')->get('words.listreferenceshldnotemt'); ?>');
					$('#reflist_error').show();
					isError = true;				
				}
			}
		...
		function deleteField(osid)
		{
			...
			Swal.fire({
				icon: 'warning',
				title: '<?php echo app('translator')->get('words.objectstructure'); ?>',
				text: '<?php echo app('translator')->get('words.areyousuredeleteobjectfield'); ?>',
				showCancelButton: true,
				customClass: {
					confirmButton: 'btn btn-success mx-2',
					cancelButton: 'btn btn-danger mx-2',
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/dk3app/resources/views/laravel/objects/object_table.blade.php ENDPATH**/ ?>