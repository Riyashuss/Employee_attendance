...
<div class="ps__rail-x" style="left: 0px; bottom: 0px;"><div class="ps__thumb-x" tabindex="0" style="left: 0px; width: 0px;"></div></div><div class="ps__rail-y" style="top: 0px; right: 0px;"><div class="ps__thumb-y" tabindex="0" style="top: 0px; height: 0px;"></div></div></aside>
    ...
    <h3 class=" text-center mt-6  ">Welcome <?php echo auth()->user()->username; ?></h3>
    <p class="text-dark text-center">Date: <?php echo e(now()->format('Y-m-d')); ?></p>
    <div class="mt-6" style="margin-left: auto;">

<!-- Container to manage responsiveness -->
    <div class="d-flex flex-wrap justify-content-start" style="gap: 20px; margin-left: auto; margin-right: auto;">

    <!-- User Card -->
            <div class="p-3 text-white text-left" 
                style="flex: 1 1 300px; max-width:60%; border-radius: 15px; background-color: white; border: 1px solid rgb(30, 127, 121);margin:auto;">
                <h3 class="text-dark text-center">User</h3>
                <div class="text-dark">
    <div style="display: flex; align-items: center; margin: 3px;">
        <span style="padding-left: 275px;">User Count</span>
        <span style="padding-left: 20px;">:</span>
        <span style="margin-left: 10px;"><?php echo e($userCount); ?></span>
    </div>

 
    <div style="display: flex; align-items: center; margin: 3px;">
        <span style="padding-left: 270px;">Total Present</span>
        <span style="padding-left: 10px;">:</span>
        <span style="margin-left: 10px;"><?php echo e($presentCount); ?></span>
    </div>

    <div style="display: flex; align-items: center; margin: 3px;">
        <span style="padding-left: 325px;">Leave</span>
        <span style="padding-left: 10px;">:</span>
        <span style="margin-left: 10px;"><?php echo e($absentCount); ?></span>
    </div>
    </div>
                <a href="<?php echo e(route('projectDetailsPage1')); ?>" class="btn btn-dark btn-sm" 
                style=" max-width:70%;margin:auto;">More..</a>
            </div>
    ...
    <!-- Project Card -->
            <div class="p-3 text-white text-left" 
                ...
                <p class="text-dark text-center">Total Projects: <?php echo e($totalProjects); ?></p>
                <p class="text-dark text-center">Current Projects: <?php echo e($currentCount > 0 ? $currentCount : 'No current projects available.'); ?></p>
                <p class="text-dark text-center">Completed Projects: <?php echo e($completedCount > 0 ? $completedCount : 'No completed projects available.'); ?></p>
            
                <a href="<?php echo e(route('projectDetailsPage')); ?>" class="btn btn-dark btn-sm text-center" 
                style=" max-width:70%;margin:auto;">More..</a>
...
<!--     
</div><button class="btn btn-light btn-sm" style="position: absolute; right: 10px; bottom: 10px;" onclick="window.location.href=''">More...</button> -->
    ...
    <script>
        ...
        toggleBtn.addEventListener("click", () => {
            ...
            if (sidebar.classList.contains("collapsed")) {
                toggleBtn.classList.add("edge"); // Move to screen edge
            } else {
                toggleBtn.classList.remove("edge"); // Keep near sidebar
            }
        });
    </script>
    <script>
...
@media screen and (max-width: 768px) {
    /* General adjustments for tablet and mobile */
    .navbar-main {
...
/* Additional media query for very small screens like 360px and below */
...
</html><?php /**PATH D:\Laravel\Nilatech_attendance\resources\views/home.blade.php ENDPATH**/ ?>