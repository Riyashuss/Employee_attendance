					...
					<div class="col-lg-6  mt-2">
						...
						<div class="input-group">
							...
							<input id="inWorkOrderName" name="inWorkOrderName" class="form-control" type="text"
								...
								placeholder="WorkOrder Name" value="">
...
unset($__errorArgs, $__bag); ?>
				...
				<div class="d-flex justify-content-center mt-4">                                
					...
					<button id="btnCreate" onclick="createWorkOrder();" type="button" class="btn btn-success m-0 ms-2">Create</button>
	...
	function createWorkOrder() {
...

		{
			...
			Swal.fire({
				...
				text: 'Please enter Work Order Name',
		...
		if (!pattern.test(workOrderName)) {
			...
			Swal.fire({
				...
				title: 'Invalid Work Order Name format',
			...
			success: function(response){
				...
				if(response.result){
					...
					Swal.fire({
						...
						text: 'Work Order Name Already Exists',
	...
	function validateFileds(){
		...
		if (workAreaId <= 0) {
			...
			Swal.fire({
				...
				text: 'Please select the workarea',
			...
			success: function(response){
			 ...
			 workOrderId = response.workorderid;
				 ...
				 Swal.fire({
					...
					text: 'Work Order is created successfully',
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Senthil\DK3\HemmingerUAT\release01_UAT_27042024\dk3app\resources\views/laravel/workorder/create.blade.php ENDPATH**/ ?>