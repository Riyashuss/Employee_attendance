...

	{
		...
		var workOrderId = $('#inWorkOrderId').val();
			...
			$.ajax({
				...
				url: '<?php echo e(route('assignToUserSurveyPost')); ?>',
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Senthil\DK3\HemmingerUAT\release01_UAT_27042024\dk3app\resources\views/laravel/survey/assigntousersurvey.blade.php ENDPATH**/ ?>