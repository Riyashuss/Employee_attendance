            ...
            $(document).ready(function () {
                ...
                var calendar = $('#calendar').fullCalendar({
                    ...
                    dayRender: function (date, cell) {
                        var today = new Date();
                        var dateObject = new Date(date.format("YYYY-MM-DD"));
                        if (dateObject < today) {
...
</html><?php /**PATH C:\xampp\htdocs\Employee_attendance\resources\views/home_user.blade.php ENDPATH**/ ?>