...
unset($__errorArgs, $__bag); ?>
								...
								<div class="row mt-4">															
									...
									<div class="col-lg-6">
										<div id="frmFiles1" class="form-group">
											<input id="file" type="file" name="file" class="form-control"  accept=".pkt">
										</div>
                                ...
                                <div class="row mt-4">															
									...
									<div class="col-lg-6">
										<div id="frmFiles1" class="form-group">
											<input id="file" type="file" name="file" class="form-control"  accept=".lne">
										</div>
...
<?php $__env->startPush('js'); ?>
        ...
        function uploadIVLFile()
	{
		...
		{
			$('#file_error').html("Please select a Pre-production file");
			$('#file_error').show();
			return;
		}
		else if ($('#file')[0].files.length>1)
		{
            $('#file_error').html("Please select one Pre-production file only");
			$('#file_error').show();
			return;
		}
        if (!($('#file')[0].files[0].name).toLowerCase().startsWith("dks3_" + workOrderName.toLowerCase() + "_preproduction_map"))
		{
			$('#file_error').html("Invalid File. File name should start with '" + "DKS3_" + workOrderName + "_Preproduction_Map'");
			$('#file_error').show();
			return;
		}
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Ramesh\Projectstart\dk3app-04-05\dk3app\resources\views/laravel/workorder/mapqc.blade.php ENDPATH**/ ?>