...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="row mt-4">                                                          
                                    ...
                                    <div class="col-lg-6">
                                        <button id="btnComplete" onclick="btnCompleteClick();" type="button" class="btn btn-success m-0 ms-2"><?php echo app('translator')->get('words.completepreproduction'); ?></button>
...
<?php $__env->startPush('js'); ?>
    ...
    function btnCompleteClick()
    {
        ...
        Swal.fire({
                icon: 'warning',
                title: '<?php echo app('translator')->get('words.workorder'); ?>',
                html: '<?php echo app('translator')->get('words.pleaseconfirmtocompletepreproduction'); ?>' + workDuration +'<?php echo app('translator')->get('words.hrs'); ?>',
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Senthil\Hemminger\Dk3app_Final\dk3app\resources\views/laravel/workorder/completepreproduction.blade.php ENDPATH**/ ?>