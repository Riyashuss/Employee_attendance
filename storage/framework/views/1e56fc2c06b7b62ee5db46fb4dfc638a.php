...
unset($__errorArgs, $__bag); ?>
						...
						<div class="row  mt-4">
							...
							<div class="col-lg-6">
								<div class="input-group">
									<textarea  id="remarks" name="remarks" class="form-control" type="text" 
						...
						<div class="row mt-4">															
							...
							<div class="col-lg-6">
								<button id="btnReassign" onclick="validateFileds();" type="button" class="btn btn-success m-0 ms-2">Reassign Map Creation</button>
...
<?php $__env->startPush('js'); ?>
	...
	function validateFileds(){
		...
		Swal.fire({
			icon: 'warning',
			title: 'User Name',
			text: 'Please select the UserName',
		...
		if ($.trim(remarks)=="")
		{
			...
			Swal.fire({
				icon: 'warning',
				title: 'Remark',
				text: 'Please Enter If Any Remark',
	...
	{	
		Swal.fire({
			icon: 'warning',
			title: 'WorkOrder',
			html: "Please confirm to Reassign Map Creation",
	...
	function processReassign()
	{
		...
		$.ajax({
			...
			url: '<?php echo e(route('reassignmapcreationPost')); ?>',
			type: 'post',
			data:fd,
			contentType: false,
			processData: false,
			success: function(response){
				...
				if (response.success)
				{
					Swal.fire({
								icon: 'success',
								title: 'WorkOrder',
								text: "WorkOrder is reassigned as completed",
								showCancelButton: false,
								customClass: {
									confirmButton: 'btn btn-success mx-2'
								},
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/dk3app/resources/views/laravel/mapcreation/reassigntousermapcreation.blade.php ENDPATH**/ ?>