    ...
    <div class="collapse navbar-collapse  w-auto h-auto" id="sidenav-collapse-main">
        ...
        <ul class="navbar-nav">
			...
			<li class="nav-item sidemenuitem" id="qc" >
                <a data-bs-toggle="collapse" href="openqc" class="nav-link <?php echo e(Route::currentRouteName() == 'qc' ? 'active' : ''); ?>"
                    aria-controls="qc" role="button" aria-expanded="false">
                    <div class="icon icon-shape icon-sm text-center d-flex align-items-end justify-content-center">
                    <i class="fa-solid fa-q" style="color: #00FF13;"></i>
                    </div>
                    <span class="nav-link-text ms-1"><?php echo app('translator')->get('QC'); ?></span>
                </a>
                <div class="collapse show" id="qc">
                    <ul class="nav ms-4">
                        <li class="nav-item ">
                            <a class="nav-link <?php echo e(Route::currentRouteName() == 'createqc' ? 'active' : ''); ?>" href="<?php echo e(route('home_qcassign')); ?>">
                                <div class="icon icon-shape icon-sm text-center d-flex align-items-end justify-content-center">
                                <i class="fa-solid fa-check"style="color: #00FF13;"></i>
                                </div>
...
<?php /**PATH D:\Senthil\DK3\HemmingerUAT\release01_UAT_27042024\dk3app\resources\views/layouts/navbars/auth/sidenav_admin.blade.php ENDPATH**/ ?>