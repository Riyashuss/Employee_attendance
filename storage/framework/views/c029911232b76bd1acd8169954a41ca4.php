<?php $__env->startSection('content'); ?>
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl ">
        <div class="container-fluid py-1 px-3">
            <?php echo $__env->make('layouts.navbars.auth.topnav', ['title' => 'Edit User'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            ...
            <div class="col-lg-9 mt-lg-0 mt-4">
                ...
                <div class="card mt-4" id="basic-info">
                    ...
                    <div class="card-body pt-0">
                        <form method="POST" action="<?php echo e(route('user-edit.update', $user->id)); ?>" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            <div class="row">
                                <div class="col-6">
                                    <label class="form-label">First Name</label>
                                    <div class="input-group">
                                        <input id="firstname" name="firstname" value="<?php echo e(old('firstname') ?? $user->firstname); ?>" class="form-control" type="text" placeholder="Firstname" >
                                    </div>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="input-group">
                                        <input id="lastname" name="lastname" value="<?php echo e(old('lastname') ?? $user->lastname); ?>" class="form-control" type="text" placeholder="Lastname">
                                    </div>
                                </div>
                            </div>
                            <div class="row mt-4">
                            ...
                            <div class="mt-4">
                                ...
                                <select name="role" id="choices-role" class="form-control">
                                    ...
                                    <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($role->id); ?>" <?php echo e($role->id == old('role', $user->role->id) ? 'selected' : ''); ?>><?php echo e($role->name); ?></option>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="row">
                                <div class="col-6">
                                    ...
                                    <div class="input-group">
                                        <input id="email" name="email" value="<?php echo e(old('email', $user->email)); ?>" class="form-control" type="email" placeholder="example@email.com">
                                    </div>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        value="<?php echo e(old('confirmation')); ?>">
                                    </div>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="row">
                                <div class="col-6">
                                    ...
                                    <div class="input-group">
                                        <input id="location" name="location" value="<?php echo e(old('location', $user->location)); ?>" class="form-control" type="text" placeholder="Sydney, A">
                                    </div>
                                </div>
                                <div class="col-6">
                                    <label class="form-label mt-4">Phone Number</label>
                                    <div class="input-group">
                                        <input id="phone" name="phone" value="<?php echo e($user->phone); ?>" class="form-control" type="number" placeholder="+40 735 631 620">
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 align-self-center">
                                    ...
                                    <select class="form-control" name="language" id="choices-language">
                                        <option value="">Choose</option>
                                        <option value="English" <?php echo e(old('language', $user->language) == 'English' ? 'selected' : ''); ?>>English</option>
                                        <option value="French" <?php echo e(old('language', $user->language) == 'French' ? 'selected' : ''); ?>>French</option>
                                        <option value="Spanish" <?php echo e(old('language', $user->language) == 'Spanish' ? 'selected' : ''); ?>>Spanish</option>
                                    </select>
                                </div>
                                <div class="col-md-6">
                                        <label class="form-label mt-4">Skills</label>
                                        <input class="form-control" id="skills" name="skills" value="<?php echo e(old('skills', $user->skills)); ?>" type="text" placeholder="Enter your skills" />
                                </div>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="d-flex justify-content-end mt-4">
                                <a href="<?php echo e(route('user-management')); ?>" class="btn btn-light m-0">Back</a>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Dk3\resources\views/laravel/users/edit.blade.php ENDPATH**/ ?>