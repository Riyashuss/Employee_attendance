...
unset($__errorArgs, $__bag); ?>
								...
								<div class="row  mt-4">
									...
									<div class="col-lg-6">
										<div class="input-group">
											<input id="inDuration" name="inDuration" class="form-control rounded" type="number" 
...
unset($__errorArgs, $__bag); ?>
								...
								<div class="row mt-4">															
									...
									<div class="col-lg-6">
										<button id="btnComplete" onclick="btnCompleteClick();" type="button" class="btn btn-success m-0 ms-2"><?php echo app('translator')->get('words.completesurvey'); ?></button>
...
<?php $__env->startPush('js'); ?>
	...
	function processComplete(workOrderId,workDuration)
	{
		...
		$.ajax({
			...
			url: '<?php echo e(route('completeSurveyPost')); ?>',
			type: 'post',
			data:fd,
			contentType: false,
			processData: false,
	...
	function btnCompleteClick()
	{
		...
		Swal.fire({
				icon: 'warning',
				title: '<?php echo app('translator')->get('words.workorder'); ?>',
				html: '<?php echo app('translator')->get('words.confirmsurvey'); ?>' + workDuration +'<?php echo app('translator')->get('words.hrs'); ?>',
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Senthil\Hemminger\Dk3app_Final\dk3app\resources\views/laravel/survey/completesurvey.blade.php ENDPATH**/ ?>