...
<?php $__env->startPush('js'); ?>
	...
	$(document).ready(function(){
		...
		dtWorkOrders = $('#workOrderTable').DataTable({
			...
			info : false,
			language: {
				emptyTable: 'No WorkOrder available for Mapcreation'
			}
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\dk3app\resources\views/home_mapqc.blade.php ENDPATH**/ ?>