...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="row mt-4">                                                          
                                    <div class="col-lg-2 pt-1 text-end">
                                        <label class="form-label"><?php echo app('translator')->get('words.mapcreationfile'); ?></label>
                                    </div>
                                ...
                                <div class="row mt-4">                                                          
                                    ...
                                    <div class="col-lg-6">
                                        <div class="col-lg-4">
                                            <button id="btnUploadIVLFile" onclick="uploadIVLFile();" type="button" class="btn btn-success m-0 ms-2"><?php echo app('translator')->get('words.assigntoqc'); ?></button>
                                        </div>
                                    </div>      
...
<?php $__env->startPush('js'); ?>
    ...
    $("#file").on("change", function() {
        ...
        {
            $('#file_error').html('<?php echo app('translator')->get('words.pleaseselectmap3dfile'); ?>');
            $('#file_error').show();
        }
        else
        {
        ...
        if (!($('#file')[0].files[0].name).toLowerCase().startsWith("dks3_" + workOrderName.toLowerCase() + "_map3d"))
        {
            $('#file_error').html('<?php echo app('translator')->get('words.invalifilestartwith'); ?>'+ "DKS3_" + workOrderName + "_Map3D");
            $('#file_error').show();
            return;
        }
    ...
    $("#company_name").on("change", function() 
        ...
        function uploadIVLFile()
        {
            ...
            {
                $('#file_error').html('<?php echo app('translator')->get('words.pleaseselectonemap3dfileonly'); ?>');
                $('#file_error').show();
                return;
            }
            if (!($('#file')[0].files[0].name).toLowerCase().startsWith("dks3_" + workOrderName.toLowerCase() + "_map3d"))
                ...
                success: function(response){
                    ...
                    if (response.success)
                    {
                        ...
                        Swal.fire({
                                    ...
                                    text: '<?php echo app('translator')->get('words.workorderisassignedforqcsuccessfuly'); ?>',
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Senthil\Hemminger\Dk3app_Final\dk3app\resources\views/laravel/workorder/mapqc.blade.php ENDPATH**/ ?>