...
unset($__errorArgs, $__bag); ?>
						...
						<div class="row mt-4">															
							...
							<div class="col-lg-6">
								...
								<button id="btnReassign" onclick="validateFileds();" type="button" class="btn btn-success m-0 ms-2"><?php echo app('translator')->get('words.reassignpreproduction'); ?></button>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Senthil\Hemminger\Dk3app_Final\dk3app\resources\views/laravel/workorder/reassigntouserpreproduction.blade.php ENDPATH**/ ?>