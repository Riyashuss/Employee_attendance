<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-2 fixed-start ms-2 bg-default
    ...
    <div class="collapse navbar-collapse  w-auto h-auto" id="sidenav-collapse-main">
        <ul class="navbar-nav" >
            ...
            <li class="nav-item sidemenuitem " id="menuCompany" style="display:none;">
                    ...
                    <ul class="nav ms-4">
						...
						<li class="nav-item ">
                            <a class="nav-link <?php echo e(Route::currentRouteName() == 'createqc' ? 'active' : ''); ?>" href="<?php echo e(route('home_mapqcassign')); ?>">
                                ...
                                <span class="sidenav-normal"> MapCreation QC </span>
                            </a>
                        </li> 
                    </ul>
                </div>
...
<?php /**PATH C:\xampp\htdocs\dk3app\resources\views/layouts/navbars/auth/sidenav_admin.blade.php ENDPATH**/ ?>