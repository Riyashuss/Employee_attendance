...
<body class="g-sidenav-show">
    ...
    <a class="navbar-brand"style="backgrounds-color:white" href="">
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item sidemenuitem" id="details" >
    ...
    <div class="d-flex justify-content-center mb-5">
        <div class="col-lg-9 mt-lg-0 mt-4">
            <div class="card mt-4" id="basic-info">
                ...
                <form action="<?php echo e(route('updates_user', auth()->user()->id)); ?>" method="POST">
                 <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
    ...
    <option value="admin" <?php echo e(auth()->user()->role_id === 1 ? 'selected' : ''); ?>>Admin</option>
    <option value="employee" <?php echo e(auth()->user()->role_id === 2 ? 'selected' : ''); ?>>Employee</option>
</select>
</div>
    </div>
                    <div class="row mt-4">
...
<script>
    $(document).ready(function() {
        ...
        const gender = document.getElementById('choices-gender') ? new Choices(document.getElementById('choices-gender')) : null;
        const role = document.getElementById('choices-role') ? new Choices(document.getElementById('choices-role')) : null;
        ...
        $('#btnUpdateUser').click(function() {
            ...
            const gender = $('#choices-gender').val();
            const dob = $('#dob').val();
            const mail = $('#mail').val();
            ...
            // if (!employeename || !joindate || !employee_id || !role || !gender || !birthday || !email) {
            //     Swal.fire({
            //         icon: 'warning',
            ...
            $.ajax({
                url: '<?php echo e(route('updateuser')); ?>/' + userId,
                type: 'POST',
                data: fd,
                contentType: false,
                processData: false,
                success: function(response) {
                    Swal.fire({
                        icon: response.success ? 'success' : 'True',
                        title: response.success ? 'User Update' : ' Successfully Updated',
...
</html><?php /**PATH C:\xampp\htdocs\Employee_attendance\resources\views/laravel/userdetails/edit.blade.php ENDPATH**/ ?>