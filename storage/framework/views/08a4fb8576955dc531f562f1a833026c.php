...
<?php $__env->startPush('js'); ?>
    ...
    function Approved(workOrderId, status_code) {
        ...
        if (status_code=="313")
       {
         Swal.fire({
                ...
                text: '<?php echo app('translator')->get('words.pleaseconfirmtoapprovemapcreation'); ?>',
    ...
    //    {
        ...
        if($.trim(remarks) == "")
        {
         ...
         Swal.fire({
                icon: 'warning',
                title: '<?php echo app('translator')->get('words.workorder'); ?>',
                text: '<?php echo app('translator')->get('words.pleaseconfirmtorejectmapcreation'); ?>',
                showCancelButton: true,
                customClass: {
                    confirmButton: 'btn btn-success mx-2',
                    cancelButton: 'btn btn-danger mx-2'
    ...
    $.ajax({
        url: '<?php echo e(route('mapapproveWorkOrder')); ?>',
        type: 'post',
            data:fd,
            contentType: false,
            processData: false,
            success: function(response){
                ...
                if (response.success)
                {
                    Swal.fire({
                                icon: 'success',
                                title: '<?php echo app('translator')->get('words.workorder'); ?>',
                                text: '<?php echo app('translator')->get('words.mapcreationapprovedsuccessfully'); ?>',
                                ...
                                window.location.href = "/home_mapqcassign";
                              });
                }
        },
...
function rejectedWorkOrder(workOrderId) {
    ...
    // Make an AJAX request
    $.ajax({
        url: '<?php echo e(route('maprejectedWorkOrder')); ?>',
        type: 'post',
            data:fd,
            contentType: false,
            processData: false,
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Senthil\Hemminger\Dk3app_Final\dk3app\resources\views/Viewqcmap.blade.php ENDPATH**/ ?>