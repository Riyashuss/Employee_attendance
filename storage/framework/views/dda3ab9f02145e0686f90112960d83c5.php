      ...
      <div class="row min-vh-80">
        ...
        <div class="col-lg-10">
            <div class="position-absolute p-3 border-radius-xl blur shadow-xl perspective-right z-index-3 mt-7">
              <a class="w-100" href="<?php echo e(route('dashboards', ['page' => 'default'])); ?>">
...
<?php echo $__env->make('layouts.app', ['class' => 'landing'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\dk3app\resources\views/dashboards/landing.blade.php ENDPATH**/ ?>