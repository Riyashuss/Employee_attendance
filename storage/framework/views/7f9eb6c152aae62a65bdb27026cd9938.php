...
<?php $__env->startPush('js'); ?>
	...
	$("#file").on("change", function() {
		...
		{
			alert("123");
			$('#file_error').html("Invalid File. File name should start with '" + "DKS3_" + workOrderName + "_Pre-production_Map'");
			$('#file_error').show();
			return;
		}
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\dk3app\resources\views/laravel/workorder/qc.blade.php ENDPATH**/ ?>