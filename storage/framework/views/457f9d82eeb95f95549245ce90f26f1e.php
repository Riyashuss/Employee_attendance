            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-header d-flex justify-content-between">
                        ...
                        <a href="<?php echo e(route('user-new')); ?>" class="btn bg-gradient-dark btn-sm float-end mb-0">Add User</a>
                    </div>
                                    ...
                                    <tr>
                                        <td class="text-sm font-weight-normal">
                                            <span class="my-2 text-xs">
                                                <img src="<?php echo e($user->avatarUrl()); ?>" alt="bruce"
                                                    class="border-radius-lg shadow-sm height-100 w-auto">
                                            </span>
                                        </td>
                                        <td class="text-sm font-weight-normal"><?php echo e($user->firstname); ?>

                                            <?php echo e($user->lastname); ?></td>
                                        <td class="text-sm font-weight-normal"><?php echo e($user->email); ?></td>
                                        <td class="text-sm font-weight-normal"><?php echo e($user->role->name); ?></td>
                                        <td class="text-sm font-weight-normal"><?php echo e($user->created_at); ?></td>
                                        <td class="text-sm">
                                            <span class="d-flex">
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('update', $user)): ?>
                                                    <a href="<?php echo e(route('user-edit', $user->id)); ?>" class="me-3"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\dk3app\resources\views/laravel/users/index.blade.php ENDPATH**/ ?>