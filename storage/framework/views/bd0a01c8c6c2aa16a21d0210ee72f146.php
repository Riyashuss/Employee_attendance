    ...
    <?php echo method_field('PUT'); ?>
                    ...
                    <div class="row">
                        <div class="col-6">
                            ...
                            <input id="username" name="username" class="form-control" type="text" placeholder="Employee Name" value="<?php echo e(old('username', $user->username)); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-6">
                            ...
                            <input id="password" name="password" class="form-control" type="password" placeholder="Leave blank to keep the same" value="<?php echo e(old('password', $user->password)); ?>">
                        </div>
                    </div>
                    ...
                    <div class="row mt-4">
                        <div class="col-6">
                            ...
                            <input id="joiningdate" name="joiningdate" class="form-control" type="date" value="<?php echo e(old('joindate', $user->joiningdate)); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-6">
                            ...
                            <input id="emp_id" name="emp_id" class="form-control" type="text" placeholder="Employee Id" value="<?php echo e(old('employee_id', $user->emp_id)); ?>" required>
    ...
    <div class="col-6">-->
        ...
        <div>
            <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <input class="form-check-input" type="checkbox" name="role_id[]" value="<?php echo e($role->id); ?>" id="role_<?php echo e($role->id); ?>" <?php echo e(in_array($role->id, $assignedRoles) ? 'checked' : ''); ?>>
	...
	<div class="row mt-1 ps-3 pe-3">
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-6">
                            ...
                            <input id="dob" name="dob" class="form-control" type="date" value="<?php echo e(old('birthday', $user->dob)); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="row mt-4">
                        <div class="col-6">
                            ...
                            <input id="mail" name="mail" class="form-control" type="email" value="<?php echo e(old('mail', $user->mail)); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-6">
                            ...
                            <input id="bloodgroup" name="bloodgroup" class="form-control" type="text" value="<?php echo e(old('bloodgroup', $user->bloodgroup)); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="row mt-4">
                        <div class="col-6">
                            ...
                            <input id="address" name="address" class="form-control" type="text" value="<?php echo e(old('address', $user->address)); ?>" placeholder="Address" required>
                        </div>

                        <div class="col-6">
                            <label class="form-label">Phone Number</label>
                            <input id="contact" name="contact" class="form-control" type="text" value="<?php echo e(old('phone', $user->contact)); ?>" placeholder="+40 735 631 620">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="d-flex justify-content-end mt-4">
                        <a href="<?php echo e(route('user_details')); ?>" class="btn btn-light m-0">Back</a>
                        <button id="btnUpdateUser" type="button" class="btn bg-gradient-primary m-0 ms-2">Save</button>
                    </div>
                </div>
    <!-- </form> -->
            </div>
...
<script>
    ...
    var isError = false; // Flag to track if there are any errors
    ...
    var gender = $('#choices-gender').val();

    var $chkrole_objects = $(".chkroles");

    // Validate required fields
    if (username.trim() === "") {
        $('#username').after('<p class="text-danger text-xs pt-1">Username is required.</p>');
        isError = true;
    }
    if (dob.trim() === "") {
        $('#dob').after('<p class="text-danger text-xs pt-1">Date of birth is required.</p>');
        isError = true;
    }
    if (address.trim() === "") {
        $('#address').after('<p class="text-danger text-xs pt-1">Address is required.</p>');
        isError = true;
    }
    if (bloodgroup.trim() === "") {
        $('#bloodgroup').after('<p class="text-danger text-xs pt-1">Blood group is required.</p>');
        isError = true;
    }
    if (mail.trim() === "") {
        $('#mail').after('<p class="text-danger text-xs pt-1">Email is required.</p>');
        isError = true;
    }
    if (contact.trim() === "") {
        $('#contact').after('<p class="text-danger text-xs pt-1">Phone number is required.</p>');
        isError = true;
    }
    if (joiningdate.trim() === "") {
        $('#joiningdate').after('<p class="text-danger text-xs pt-1">Joining date is required.</p>');
        isError = true;
    }
    if (emp_id.trim() === "") {
        $('#emp_id').after('<p class="text-danger text-xs pt-1">Employee ID is required.</p>');
        isError = true;
    }
    if (gender === "") {
        $('#choices-gender').after('<p class="text-danger text-xs pt-1">Gender is required.</p>');
        isError = true;
    }

    // Validate roles
    $chkrole_objects.each(function() {
        if (this.checked) {
    ...
    fd.append('choices-gender', gender);
    ...
    $.ajax({
    url: "<?php echo e(route('updates_users')); ?>",
    type: 'POST',  
    data: fd,
    processData: false,
    contentType: false,
    ...
    error: function(xhr) {
        ...
        $.each(errors, function(field, messages) {
            var fieldName = '#' + field;
            $(fieldName).after('<p class="text-danger text-xs pt-1">' + messages[0] + '</p>');
        });
    }
});
});
...
</html><?php /**PATH C:\xampp\htdocs\Nilatech_attendance\resources\views/laravel/userdetails/edit.blade.php ENDPATH**/ ?>