...
<?php $__env->startSection('content'); ?>
    ...
    <div class="card mx-1 my-1  mt-1 pt-1" id="basic-info">
		...
		<div class="card-header  mt-1 pt-1">
			...
			<h5>Work Order assignment to Map Creation</h5>
...
<?php $__env->startPush('js'); ?>
...

	{
		...
		else if ($('#file1')[0].files[0].name.toLowerCase() != workOrderName.toLowerCase() + "_basemap.dwg")

		{

			$('#file1_error').html("Name mismatch. Please select a Base Map file for the workorder");
		...
		else if ($('#file2')[0].files[0].name.toLowerCase() != workOrderName.toLowerCase() + "_preproductionmap.dwg")

		{

			$('#file2_error').html("Name mismatch. Please select a Pre-production file for the workorder");
		...
		else if ($('#file3')[0].files[0].name.toLowerCase() != workOrderName.toLowerCase() + "_surveymap.dwg")

		{

			$('#file3_error').html("Name mismatch. Please select a Survey file for the workorder");
...

		{
			...
			surveyMapName = $('#file2')[0].files[0].name;
...

	{
		...
		var fd = new FormData();
			...
			$.ajax({
				...
				url: '<?php echo e(route('file.upload.dwgForMapCreation')); ?>',
...

	{
			...
			fd.append('baseMapNameServe',baseMapNameServer);
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\dk3app\resources\views/laravel/modelcreation/assigntomodelcreation.blade.php ENDPATH**/ ?>