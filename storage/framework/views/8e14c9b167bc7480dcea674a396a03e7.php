...
unset($__errorArgs, $__bag); ?>
								...
								<div class="row mt-4">															
									...
									<div class="col-lg-6">
										...
										<button id="btnComplete" onclick="btnCompleteClick();" type="button" class="btn btn-success m-0 ms-2">Complete Map Creation</button>
...
<?php $__env->startPush('js'); ?>
...

	{
		...
		Swal.fire({
				...
				html: "Please confirm to complete Map Creation.<br>Duration : " + workDuration +"(Hrs)",
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Ramesh\Projectstart\dk3app-04-05\dk3app\resources\views/laravel/mapcreation/completemapcreation.blade.php ENDPATH**/ ?>