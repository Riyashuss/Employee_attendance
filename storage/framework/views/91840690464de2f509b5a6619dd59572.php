...
<!-- Container to manage responsiveness -->
    ...
    <!-- User Card -->
            <div class="p-3 text-white text-left" 
                ...
                <p class="text-dark text-center">Count: <?php echo e($userCount); ?></p>
                
                <p class="text-dark text-center">Total Present: <?php echo e($presentCount); ?></p>
                <p class="text-dark text-center">Leave: <?php echo e($absentCount); ?></p>
...
</html><?php /**PATH C:\xampp\htdocs\Nilatech_attendance\resources\views/home.blade.php ENDPATH**/ ?>