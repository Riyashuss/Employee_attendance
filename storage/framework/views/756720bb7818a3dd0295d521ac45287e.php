...
<div class="container-fluid my-5 py-2">
    <div class="d-flex justify-content-center mb-5">
        <div class="col-lg-9 mt-lg-0 mt-4">
            <div class="card mt-4" id="basic-info">
                ...
                <form action="<?php echo e(route('updates', auth()->user()->id)); ?>" method="POST">
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-6 mt-4">
                            ...
                            <input id="username" name="username" class="form-control"  placeholder="Leave blank to keep the same" value="<?php echo auth()->user()->username; ?>">
                        </div>
                        <div class="col-6 mt-4">
                            <label class="form-label">Mails</label>
                            <input id="mail" name="mail" class="form-control" type="text" placeholder="mail" value="<?php echo auth()->user()->mail; ?>" required>
                        </div>
                    </div>
                    ...
                    <div class="row mt-4">
                        <div class="col-6 mt-4">
                            ...
                            <input id="dob" name="dob" class="form-control" type="text" value="<?php echo auth()->user()->dob; ?>" required>
                          
                        </div>

                        <div class="col-6 mt-4">
                            <label class="form-label">Address</label>
                            <input id="address" name="address" class="form-control" type="text" placeholder="address" value="<?php echo auth()->user()->address; ?>" required>
                    ...
                    <div class="row mt-4">
                        <div class="col-6 mt-4">
                            ...
                            <input id="bloodgroup" name="bloodgroup" class="form-control" type="text" placeholder="bloodgroup" value="<?php echo auth()->user()->bloodgroup; ?>" required>
                        </div>

                    
                        <div class="col-6 mt-4">
                            <label class="form-label">Gender</label>
                            <input id="gender" name="gender" class="form-control" type="text" placeholder="mail" value="<?php echo auth()->user()->gender; ?>" required>
                        </div>
                    </div>
                    ...
                    <div class="row mt-4">
                        <div class="col-6 mt-4">
                            ...
                            <input id="contact" name="contact" class="form-control" type="text" value="<?php echo auth()->user()->contact; ?>" required>
                        ...
                        <div class="col-6 mt-4">
                            ...
                            <input id="joiningdate" name="joiningdate" class="form-control" type="text" value="<?php echo auth()->user()->joiningdate; ?>" required>
                        </div>
                    </div>
                    <div class="row mt-4">
                        <div class="col-6 ">
                            ...
                            <input id="emp_id" name="emp_id" class="form-control" type="text" value="<?php echo auth()->user()->emp_id; ?>" required>
    ...
    <div class="form-control bg-light">
        <?php 
            ...
            $userRoles = explode(',', auth()->user()->role_id); // Assuming roles are stored as comma-separated values
            $roleNames = array_intersect_key($roles, array_flip($userRoles));
                    ...
                    <div class="row mt-6">
                        <div class="col-7 ">
                            <div class="d-flex justify-content-end mt-4">
                                <button type="submit" class="btn btn-primary m-0">Update</button>
                            </div>
                        </div>
                    </div>
...
</html><?php /**PATH C:\xampp\htdocs\Nilatech_attendance\resources\views//update.blade.php ENDPATH**/ ?>