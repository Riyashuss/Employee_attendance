...
<?php $__env->startPush('js'); ?>
	...
	$("#file2").on("change", function() {
		...
		if (!($('#file2')[0].files[0].name).toLowerCase().startsWith("dks3_" + workOrderName.toLowerCase() + "_pre-production_map"))
		{
			$('#file2_error').html("Invalid File. File name should start with '" + "DKS3_" + workOrderName + "_Pre-production_Map'");
			$('#file2_error').show();
			return;
		}
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Senthil\DK3\HemmingerUAT\release01_UAT_27042024\dk3app\resources\views/laravel/survey/assigntosurvey.blade.php ENDPATH**/ ?>