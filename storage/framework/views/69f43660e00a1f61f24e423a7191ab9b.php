                                ...
                                <td class="text-sm text-center font-weight-normal text-middle">
                                    <button class='btn btn-icon btn-2 btn-success mb-0 me-1' type='button' onclick='processClick("<?php echo e($workOrder->workorderid); ?>","<?php echo e($workOrder->status_code); ?>");'>
                                        <span class='btn-inner--icon'><i class='fa fa-edit'></i>
                                            ...
                                            <?php elseif($workOrder->status_code == '111'): ?>  <?php echo 'Check  preproduction'; ?>
                                            <?php elseif($workOrder->status_code == '103'): ?>  <?php echo ' Assign to Survey'; ?>
                                            <?php elseif($workOrder->status_code == '110'): ?>  <?php echo 'Qc Pending'; ?>
        ...
        else if (status_code=="102")
       {
        ...
        if (result.isConfirmed) {
            ...
            window.location.href = '/completePreproduction/' + workOrderId ; 
                ...
                Swal.fire({
                    icon: 'error',
                    title: ' No elements found for the workorder in the database.Please export the elements!',
                    text: response.message
                });
            }
        },
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Senthil\DK3\HemmingerUAT\release01_UAT_27042024\dk3app\resources\views/home_preproduction.blade.php ENDPATH**/ ?>