	...
	function assignToUser()
	{
		...
		console.log(workOrderId);
			...
			$.ajax({
				...
				url: '<?php echo e(route('assignToUserqcmodelCreationPost')); ?>',
				type: 'post',
				data:fd,
				contentType: false,
				processData: false,
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Dk3app_Final\Dk3app_Final\dk3app\resources\views/laravel/modelcreation/assigntouserqcmodel.blade.php ENDPATH**/ ?>