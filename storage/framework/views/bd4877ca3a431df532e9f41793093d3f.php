...

    {
        ...
        var workOrderId = $('#inWorkOrderId').val();
            ...
            $.ajax({
                ...
                url: '<?php echo e(route('assignToUserqcpreCreationPost')); ?>',
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Senthil\Hemminger\Dk3app_Final\dk3app\resources\views/laravel/workorder/assigntouserqcprecreation.blade.php ENDPATH**/ ?>