...
<div class="ps__rail-x" style="left: 0px; bottom: 0px;"><div class="ps__thumb-x" tabindex="0" style="left: 0px; width: 0px;"></div></div><div class="ps__rail-y" style="top: 0px; right: 0px;"><div class="ps__thumb-y" tabindex="0" style="top: 0px; height: 0px;"></div></div></aside>
    ...
    <div class="card" id="basic-info" style="width:55rem;margin: auto;">
    <div class="card-body mt-5 "style="">
    <h3 class=" text-center mt-4  ">User Details</h3>
            <div class="d-flex justify-content-between align-items-center">
                <!-- <h5 class="card-title mb-0"style="margin-left:350px;">User Details Table</h5> -->
                <button class="btn btn-icon btn-2 btn-info" style="margin-left:auto;background-color:#57A6A1;"type="button" onclick="adduser()">
                    <span class="btn-inner--icon"><i class="fa fa-edit"></i> Add User</span>
                </button>
            </div>
            <div class="table-responsive mt-3">
            <table class="table" id="workOrderTable">
                    <thead class=" text-white"style="background-color:#C48264;" >
                         
                        <tr>
                        <th class="text-sm text-center">Employee</th>                            
                        <th class="text-sm text-center">Employee</th>
                            <th class="text-sm text-center">Mail ID</th>
                           <!-- <th class="text-sm text-center">Project-Task</th>
                            <th class="text-sm text-center">Task-Status</th> -->
                            <th class="text-sm text-center"><?php echo app('translator')->get('words.action'); ?></th>
                        </tr>
                    </thead>
                    <tbody>
                    
                        <?php $__currentLoopData = $details; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Userdetail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                        <td>
                                <button style="background-color:#004A67;" class="btn btn-icon btn-2 btn-info mb-0 me-1" type="button" onclick="edituserdetails(<?php echo e($Userdetail->id); ?>)">
                                <span class="btn-inner--icon"><i class="fa fa-user"></i> </span>
                                </button>
                            </td>
                            <td class="text-sm text-center font-weight-normal"><?php echo e($Userdetail->uname); ?></td>
                            <td class="text-sm text-center font-weight-normal"><?php echo e($Userdetail->mail); ?></td>
                            <!-- <td class="text-sm text-center font-weight-normal"><?php echo e($Userdetail->tname); ?></td> --> 
    ...
    ?>
    <?php echo e($statuses[$Userdetail->status] ?? 'New'); ?>

</td> -->
                            <td class="text-sm text-center font-weight-normal">
                                <button class="btn btn-icon btn-2  mb-0 me-1"style="background-color:#57A6A1;"  type="button"onclick="viewUser(<?php echo e($Userdetail->id); ?>)"
>
                                    <span class="btn-inner--icon"style="color:white;"><i class="fa fa-eye"></i> </span>
                                </button>
                                <button style="background-color:#004A67;" class="btn btn-icon btn-2 btn-info mb-0 me-1" type="button" onclick="edituser(<?php echo e($Userdetail->id); ?>)">
                                    <span class="btn-inner--icon"><i class="fa fa-edit"></i> </span>
                                </button>
                                <button class="btn btn-icon btn-2 btn-danger mb-0 me-1" type="button" onclick=" updateuserAction(<?php echo e($Userdetail->id); ?>)">
...
<?php $__env->startPush('js'); ?>
    ...
    function edituserdetails(userId) {
        window.location.href = "/checkuserid/" + userId;
    }

    function edituser(userId) {
    
    window.location.href = "/checkid/" + userId;
    }
...
function updateuserAction(user_id) {
    Swal.fire({
        title: 'Are you sure?',
        ...
        if (result.isConfirmed) {
            $.ajax({
                url: '<?php echo e(route('update-user-action')); ?>', // Ensure the route is correct
                type: 'POST',
                data: {
                    user_id: user_id,
...
<?php /**PATH C:\xampp\htdocs\Employee_attendance\resources\views/home_userdetails.blade.php ENDPATH**/ ?>