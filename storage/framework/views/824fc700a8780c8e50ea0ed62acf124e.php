...
<div class="container d-flex flex-column justify-content-center align-items-center" style="min-height: 100vh;">
    <h2 class="mb-4 text-center" style="color: #8D0B41;"><strong>User-Project Detail</strong></h2> <!-- Updated color -->
    <div class="card shadow-lg w-75">
        <div class="card-body">
            <!-- Display Username -->
            <h5 class="text-center" style="color:rgb(255, 87, 51);">
                <strong>Username:</strong> <?php echo e($userDetails->first()->username); ?>

            </h5>

            <div class="mt-4">
                <h5 class="text-secondary border-bottom pb-2">Projects and  Tasks  </h5>

                <?php
                    // Group projects and filter out tasks with null or empty task_name
                    $groupedProjects = $userDetails->whereNotNull('task_name')->groupBy('project_name');
                ?>

                <?php if($groupedProjects->isNotEmpty()): ?>
                    <ul class="list-group list-group-flush">
                        <?php $__currentLoopData = $groupedProjects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $projectName => $tasks): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li class="list-group-item">
                                ...
                                <p >
                                    <span class="badge bg-info text-dark mb-0">
                                        ...
                                        <?php $__currentLoopData = $tasks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $task): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php if(!empty($task->task_name)): ?>
                                                <li class="text-dark">
                                                    ...
                                                    <strong>Task :</strong> <?php echo e($task->task_name); ?>
                                ...
                                <?php else: ?>
                                    <p class="text-muted ms-4 mt-2">No tasks available for this project.</p>
                                <?php endif; ?>
                            </li>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </ul>
                <?php else: ?>
                    <p class="text-center text-danger mt-3">No tasks assigned.</p>
                <?php endif; ?>
            </div>

            <!-- Back Button -->
            <div class="text-center mt-4">
                <a href="<?php echo e(url()->previous()); ?>" class="btn btn-secondary px-4 py-2 shadow-sm">
...
</html><?php /**PATH C:\xampp\htdocs\Nilatech_attendance\resources\views/home_viewdetails.blade.php ENDPATH**/ ?>