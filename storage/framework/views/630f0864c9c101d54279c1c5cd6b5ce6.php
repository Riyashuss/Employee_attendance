...
<?php $__env->startPush('js'); ?>
    ...
    function Approved(workOrderId, status_code) {
        if (status_code=="310")
       {
         Swal.fire({
                icon: 'warning',
                title: 'WorkOrder',
                text: "Please confirm to Approved Mapcreation",
    ...
    //    {
         Swal.fire({
                icon: 'warning',
                title: 'WorkOrder',
                text: "Please confirm to reject Mapcreation",
                showCancelButton: true,
                customClass: {
                    confirmButton: 'btn btn-success mx-2',
                    cancelButton: 'btn btn-danger mx-2'
            ...
            success: function(response){
                ...
                if (response.success)
                {
                    Swal.fire({
                                icon: 'success',
                                title: 'WorkOrder',
                                text: "Mapcreation Approved successfully",
            ...
            success: function(response){
                ...
                if (response.success)
                {
                    Swal.fire({
                                icon: 'success',
                                title: 'WorkOrder',
                                text: "Mapcreation Rejected successfully",
                                showCancelButton: false,
                                customClass: {
                                    confirmButton: 'btn btn-success mx-2'
                                },
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\dk3app\resources\views/Viewqcmap.blade.php ENDPATH**/ ?>