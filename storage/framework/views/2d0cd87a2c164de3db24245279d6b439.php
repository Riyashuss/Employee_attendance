...
<div class="card mt-7" id="basic-info" style="background-color:#F2F9FF;width: 50rem;margin-left: 18rem;">
<div class="card-body">
	...
	function assignToUser()
	{
		...
		if(parseInt(assignedToUserId) === 0)
		{
			...
			$.ajax({
				...
				url: '<?php echo e(route('assigntasktousers')); ?>',
				type: 'post',
				data:fd,
				contentType: false,
				processData: false,
...
<?php /**PATH C:\xampp\htdocs\Employee_attendance\resources\views/laravel/project/update_project.blade.php ENDPATH**/ ?>