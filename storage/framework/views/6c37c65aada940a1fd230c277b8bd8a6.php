...
<div class="container-fluid my-5 py-2">
    ...
    <select id="role_id" name="role_id" class="form-control" required>
        <option value="1" <?php echo auth()->user()->role_id == 1 ? 'selected' : ''; ?>>Admin</option>
        <option value="2" <?php echo auth()->user()->role_id == 2 ? 'selected' : ''; ?>>Employee</option>
    </select>
</div>
                    </div>
                    <div class="row mt-6">
...
</html><?php /**PATH C:\xampp\htdocs\Employee_attendance\resources\views//update.blade.php ENDPATH**/ ?>