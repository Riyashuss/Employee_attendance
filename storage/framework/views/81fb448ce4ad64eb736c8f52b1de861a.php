...
unset($__errorArgs, $__bag); ?>
								...
								<div class="row mt-4">															
									...
									<div class="col-lg-6">
										...
										<button id="btnComplete" onclick="btnCompleteClick();" type="button" class="btn btn-success m-0 ms-2">Complete Survey</button>
...
<?php $__env->startPush('js'); ?>
...

	{
		...
		Swal.fire({
				...
				html: "Please confirm to complete Survey.<br>Duration : " + workDuration +"(Hrs)",
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Senthil\DK3\HemmingerUAT\release01_UAT_27042024\dk3app\resources\views/laravel/survey/completesurvey.blade.php ENDPATH**/ ?>