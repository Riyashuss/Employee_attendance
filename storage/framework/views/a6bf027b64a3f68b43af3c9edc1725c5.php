...
unset($__errorArgs, $__bag); ?>
						...
						<div class="row mt-4">															
							...
							<div class="col-lg-6">
								<button id="btnReassign" onclick="validateFileds();" type="button" class="btn btn-success m-0 ms-2">Reassign Survey</button>
...
<?php $__env->startPush('js'); ?>
	...
	{	
		Swal.fire({
			icon: 'warning',
			title: 'WorkOrder',
			html: "Please confirm to Reassign Survey",
	...
	function processReassign()
	{
		...
		$.ajax({
			...
			url: '<?php echo e(route('reassignSurveyPost')); ?>',
			type: 'post',
			data:fd,
			contentType: false,
			processData: false,
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\dk3app\resources\views/laravel/survey/reassigntousersurvey.blade.php ENDPATH**/ ?>