<?php $__env->startSection('content'); ?>
    <nav class="navbar navbar-main navbar-expand-lg  px-0 mx-4 shadow-none border-radius-xl z-index-sticky " id="navbarBlur"
        ...
        <div class="container-fluid py-1 px-3">
            <?php echo $__env->make('layouts.navbars.auth.topnav', ['title' => 'Role Management'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                ...
                <div class="card">
                    ...
                    <div class="card-header d-flex justify-content-between">
                        ...
                        <?php if(!config('app.is_demo')): ?>
                            <a href="<?php echo e(route('role-new')); ?>" class="btn bg-gradient-dark btn-sm float-end mb-0">Add
                                Role</a>
                        <?php endif; ?>
                    </div>
                        ...
                        <table class="table table-flush" id="datatable-basic">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td class="text-sm font-weight-normal"><?php echo e($role->name); ?></td>
                                        <td class="text-sm font-weight-normal"><?php echo e($role->description); ?></td>
                                        <td class="text-sm font-weight-normal"><?php echo e($role->created_at); ?></td>
                                        <td class="text-sm">
                                            <span class="d-flex">
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manage-users', auth()->user())): ?>
                                                    <a href="<?php echo e(route('role-edit', $role->id)); ?>" class="me-3"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\dk3app\resources\views/laravel/role/index.blade.php ENDPATH**/ ?>