...
<?php $__env->startSection('content'); ?>
	<nav class="navbar navbar-main navbar-expand-lg px-0 mx-1 shadow-none border-radius-xl mt-2 bg-primary ">
		<div class="container-fluid py-1 px-3">
			<?php echo $__env->make('layouts.navbars.auth.topnav', ['title' => trans('words.woassignmenttomodelcreation')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <div class="card mx-1 my-1  mt-1 pt-1" id="basic-info">
		<div class="card-header  mt-1 pt-1">
			<h5><?php echo app('translator')->get('words.woassignmenttomodelcreation'); ?></h5>
		</div>
...
unset($__errorArgs, $__bag); ?>
								...
								<div class="row mt-4">															
									...
									<div class="col-lg-6">
										<button id="btnComplete" onclick="btnCompleteClick();" type="button" class="btn btn-success m-0 ms-2"><?php echo app('translator')->get('words.completemodelcreation'); ?></button>
...
<?php $__env->startPush('js'); ?>
	...
	function processComplete(workOrderId,workDuration)
	{
		...
		$.ajax({
			...
			url: '<?php echo e(route('completemodelcreationPost')); ?>',
			type: 'post',
			data:fd,
			contentType: false,
			processData: false,
	...
	function btnCompleteClick()
	{
		...
		Swal.fire({
				icon: 'warning',
				title: '<?php echo app('translator')->get('words.workorder'); ?>',
				html:  '<?php echo app('translator')->get('words.pleaseconfirmtocompletemodelcreationduration'); ?>' + workDuration +"(Hrs)",
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Dk3app_Final\Dk3app_Final\dk3app\resources\views/laravel/modelcreation/completemodelcreation.blade.php ENDPATH**/ ?>