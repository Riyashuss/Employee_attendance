<?php $__env->startSection('content'); ?>
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl ">
        <div class="container-fluid py-1 px-3">
            <?php echo $__env->make('layouts.navbars.auth.topnav', ['title' => 'New User'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            ...
            <div class="col-lg-9 mt-lg-0 mt-4">
                ...
                <div class="card mt-4" id="basic-info">
                    ...
                    <div class="card-body pt-0">
                        <form method="POST" action="<?php echo e(route('user-new.store')); ?>" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            <div class="row">
                                <div class="col-6">
                                ...
                                <select name="role" id="choices-role" class="form-control">
                                    ...
                                    <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($role->id); ?>"
                                            <?php echo e($role->id == old('role') ? 'selected' : ''); ?>><?php echo e($role->name); ?>
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="input-group">
                                        <input id="confirmation" name="confirmation" class="form-control" type="email"
                                            placeholder="example@email.com" value="<?php echo e(old('confirmation')); ?>">
                                    </div>
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="input-group">
                                        <input id="location" name="location" class="form-control" type="text"
                                            value="<?php echo e(old('location')); ?>" placeholder="Sydney, A">
                                    </div>
                                </div>
                                <div class="col-6">
                            ...
                            <div class="row">
                                <div class="col-md-6 align-self-center">
                                    ...
                                    <select class="form-control" name="language" id="choices-language">
                                        <option value="">Choose</option>
                                        <option value="English" <?php echo e(old('language') == 'English' ? 'selected' : ''); ?>>
                                            English</option>
                                        <option value="French" <?php echo e(old('language') == 'French' ? 'selected' : ''); ?>>French
                                        </option>
                                        <option value="Spanish" <?php echo e(old('language') == 'Spanish' ? 'selected' : ''); ?>>
                                            Spanish</option>
                                    </select>
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <input class="form-control" id="skills" name="skills" type="text"
                                        placeholder="Enter your skills" value="<?php echo e(old('skills')); ?>" />
                                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Dk3\resources\views/laravel/users/create.blade.php ENDPATH**/ ?>