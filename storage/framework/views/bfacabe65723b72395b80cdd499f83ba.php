...
<div class="ps__rail-x" style="left: 0px; bottom: 0px;"><div class="ps__thumb-x" tabindex="0" style="left: 0px; width: 0px;"></div></div><div class="ps__rail-y" style="top: 0px; right: 0px;"><div class="ps__thumb-y" tabindex="0" style="top: 0px; height: 0px;"></div></div></aside>
   ...
   <div class="container">
       ...
       <div class="card" id="basic-info"style="max-width: 80%; margin-left:5%; padding: 10px;">
       <h3 class="mt-9 text-center">User Details</h3>
<?php
    use Carbon\Carbon;
?>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <p><strong>Total Working Days (This Month):</strong> <?php echo e($workingDays); ?></p>
                        </div>
                        <div class="modal-footer">
...
<?php /**PATH C:\xampp\htdocs\Nilatech_attendance\resources\views/laravel/project/user_project.blade.php ENDPATH**/ ?>