                            ...
                            <div class="avatar avatar-xl position-relative">
                                <div>
                                    ...
                                    <span class="h-12 w-12 rounded-full overflow-hidden bg-gray-100">
                                        <img src="<?php echo e(auth()->user()->avatarUrl()); ?>" alt="bruce"
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="input-group">
                                        <input id="firstname" name="firstname" class="form-control" type="text"
                                            value="<?php echo e(auth()->user()->firstname); ?>" placeholder="Alec">
                                    </div>
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="input-group">
                                        <input id="lastname" name="lastname" class="form-control" type="text"
                                            value="<?php echo e(auth()->user()->lastname); ?>" placeholder="Thompson">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-4 col-6">
                                    ...
                                    <select class="form-control" name="gender" id="choices-gender">
                                        ...
                                        <option value="Male" <?php echo e(auth()->user()->gender == 'Male' ? 'selected' : ''); ?>>Male
                                        </option>
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="input-group">
                                        <input id="email" name="email" class="form-control" type="email"
                                            <?php echo e(config('app.is_demo') && (auth()->user()->id == 1 || auth()->user()->id == 2 || auth()->user()->id == 3)? 'disabled': ''); ?>
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="input-group">
                                        <input id="location" name="location" class="form-control" type="text"
                                            value="<?php echo e(auth()->user()->location); ?>" placeholder="Sydney, A">
                                    </div>
                                </div>
                                <div class="col-6">
                                ...
                                <div class="col-md-6 align-self-center">
                                    ...
                                    <select class="form-control" name="language" id="choices-language">
                                        ...
                                        <option value="English"
                                            <?php echo e(auth()->user()->language == 'English' ? 'selected' : ''); ?>>English
                                        </option>
                                        <option value="French"
                                            <?php echo e(auth()->user()->language == 'French' ? 'selected' : ''); ?>>French</option>
                                        <option value="Spanish"
                                            <?php echo e(auth()->user()->language == 'Spanish' ? 'selected' : ''); ?>>Spanish
                                        </option>
                                    </select>
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <input class="form-control" id="skills" name="skills" type="text"
                                        value="<?php echo e(auth()->user()->skills); ?>" placeholder="Enter your skills" />
                                </div>
                            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\dk3app\resources\views/laravel/user-profile.blade.php ENDPATH**/ ?>