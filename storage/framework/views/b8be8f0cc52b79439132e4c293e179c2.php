...
<?php $__env->startSection('content'); ?>
	...
	<nav class="navbar navbar-main navbar-expand-lg px-0 mx-1 shadow-none border-radius-xl mt-2 bg-primary ">
        ...
        <div class="container-fluid py-1 px-3">
			...
			<?php echo $__env->make('layouts.navbars.auth.topnav', ['title' => 'Data Preparation'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...

	{
		...
		var workOrderId = $('#inWorkOrderId').val();
			...
			$.ajax({
				...
				url: '<?php echo e(route('assignToUserDatapreparationPost')); ?>',
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Senthil\DK3\HemmingerUAT\release01_UAT_27042024\dk3app\resources\views/laravel/datapreparation/assigntouserdatapreparation.blade.php ENDPATH**/ ?>