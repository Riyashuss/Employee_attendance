...
<?php $__env->startSection('content'); ?>
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-1 shadow-none border-radius-xl  mt-2 bg-primary">
        <div class="container-fluid py-1 px-3 ">
            <?php echo $__env->make('layouts.navbars.auth.topnav', ['title' => trans('words.queryclarification')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <div class="card mx-1 my-1  mt-1 pt-1" id="basic-info">
		<div class="card-header  mt-1 pt-1">
			<h5><?php echo app('translator')->get('words.queryclarification'); ?></h5>
		</div>
...
unset($__errorArgs, $__bag); ?>
						...
						<div class="row  mt-4">
							<div class="col-lg-2 pt-1 text-end">
								<label class="form-label"><?php echo app('translator')->get('words.querydescription'); ?></label>
							</div>
                            <div class="col-lg-6">
                                <div class="input-group">
                                    <textarea id="Description" name="Description" class="form-control" 
                                            placeholder="<?php echo app('translator')->get('words.querydescription'); ?>" rows="5" cols="50"></textarea>
                                </div>
						...
						<div class="row mt-4">															
							...
							<div class="col-lg-6">
								<button id="btnReassign" onclick="validateFileds();" type="button" class="btn btn-success m-0 ms-2"><?php echo app('translator')->get('words.submitquery'); ?></button>
...
<?php $__env->startPush('js'); ?>
	...
	function validateFileds(){
		...
		if ($.trim(CompanyName)=="")
		{
			...
			Swal.fire({
				icon: 'warning',
				title: '<?php echo app('translator')->get('words.cname'); ?>',
				text: '<?php echo app('translator')->get('words.selecteanycompany'); ?>',
		...
		if ($.trim(Description)=="")
		{
			...
			Swal.fire({
				icon: 'warning',
				title: '<?php echo app('translator')->get('words.querydescription'); ?>',
				text: '<?php echo app('translator')->get('words.pleaseenteranyquery'); ?>',
				//html: '<div class="form-group"><label class="form-label">Please enter Work Order Name.</label></div>',
				showCancelButton: false,
				customClass: {
				confirmButton: 'btn btn-success mx-2',
	...
	{	
		Swal.fire({
			...
			html: '<?php echo app('translator')->get('words.confirmsubmitquery'); ?>',
			...
			success: function(response){
				...
				if (response.success)
				{
					Swal.fire({
								icon: 'success',
								title: '<?php echo app('translator')->get('words.workorder'); ?>',
								text: '<?php echo app('translator')->get('words.querysubmittedsucess'); ?>',
								showCancelButton: false,
								customClass: {
									confirmButton: 'btn btn-success mx-2'
								},
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Senthil\Hemminger\Dk3app_Final\dk3app\resources\views/laravel/mapcreation/queryclarificationmap.blade.php ENDPATH**/ ?>