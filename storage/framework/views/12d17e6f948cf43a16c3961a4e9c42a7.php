...
<?php $__env->startSection('content'); ?>
    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-1 shadow-none border-radius-xl mt-2 bg-primary ">
        ...
        <div class="container-fluid py-1 px-3">
            ...
            <?php echo $__env->make('layouts.navbars.auth.topnav', ['title' => 'Work order assignment to Pre-production'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <div class="card mx-1 my-1  mt-1 pt-1" id="basic-info">
        ...
        <div class="card-header  mt-1 pt-1">
            ...
            <h5>Work Order assignment to Pre-production</h5>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="row mt-4">                                                          
                                    <div class="col-lg-2 pt-1 text-end">
                                        <label class="form-label">IVL Drawing File</label>
                                    </div>
                                    <div class="col-lg-6">
                                ...
                                <div class="row mt-4">
                                    <div class="col-lg-2 pt-1 text-end">
                                        <label class="form-label">IVL File</label>
                                    </div>
                                    <div class="col-lg-6">
                                ...
                                <div class="row mt-4">
                                    <div class="col-lg-2 pt-1 text-end">
                                        <label class="form-label">Point Cloud</label>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="d-flex align-items-center justify-content-start">
                                            <div class="form-check form-switch ms-3 position-relative">
                                ...
                                <div class="row mt-4">
                                    <div class="col-lg-2 pt-1 text-end">
                                        <label class="form-label">Ortho Images</label>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="d-flex align-items-center justify-content-start">
                                            <div class="form-check form-switch ms-3 position-relative">
                                ...
                                <div class="row mt-4">
                                    <div class="col-lg-2 pt-1 text-end">
                                        <label class="form-label">Kable Plan</label>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="d-flex align-items-center justify-content-start">
                                            <div class="form-check form-switch ms-3 position-relative">
                                    ...
                                    <div class="col-md-2 mt-2">
                                        ...
                                        <div class="form-check">
                                            ...
                                            <label class="custom-control-labels" for="default_user">Geo Reference</label>
                                        </div>
                                ...
                                <div class="row mt-4">    
                                    ...
                                    <div class="col-lg-6">
                                        <div class="col-lg-4">
                                            <button id="btnUploadIVLFile" onclick="uploadIVLFile();" type="button" class="btn btn-success m-0 ms-2">Assign To Company</button>
                                        </div>
...
function uploadIVLFile() {
    ...
    if ($('#file1')[0].files.length == 0) {
        ...
        if (!selectedFile.name.toLowerCase().startsWith(workOrderName.toLowerCase())) {
            $('#file_error').html("Invalid File. File name should start with '" + workOrderName + "'");
            $('#file_error').show();
            return;
        }
        file = selectedFile;
        ...
        success: function(response) {
            if (response.success) {
                Swal.fire({
                    ...
                    text: "WorkOrder is assigned successfully",
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/dk3app/resources/views/laravel/workorder/assigntopreproduction.blade.php ENDPATH**/ ?>