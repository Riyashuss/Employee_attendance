...
<nav class="navbar navbar-main navbar-expand-lg px-0 mx-1 shadow-none border-radius-xl mt-2 bg-primary ">
    ...
    <div class="card mx-1 my-1  mt-1 pt-1" id="basic-info">
        <div class="card-header  mt-1 pt-1">
            <h5><?php echo app('translator')->get('words.woassignmenttosurvey'); ?></h5>
        </div>
                    ...
                    <div id="cardBodyMain" class="card-body">
                            ...
                            <!--<hr class="my-1" />-->
                                ...
                                <div class="row  mt-4">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="input-group">
                                        <input id="inCompanyName" name="company_name" id="company_name" class="form-control rounded" type="text" readonly
                                                value="<?php echo e($companies->company_name); ?>">
                                        <input type="hidden" id="company_name" name="company_name" value="<?php echo e($companies->id); ?>">
                                        </div>
                                ...
                                <div class="row mt-4">                                                          
                                    <div class="col-lg-2 pt-1 text-end">
                                        <label class="form-label"><?php echo app('translator')->get('words.basemap'); ?></label>
                                    </div>
                                    <div class="col-lg-6">
                                ...
                                <div class="row mt-4">                                                          
                                    <div class="col-lg-2 pt-1 text-end">
                                        <label class="form-label"><?php echo app('translator')->get('words.surveymap'); ?></label>
                                    </div>
                                    <div class="col-lg-6">
                                ...
                                <div class="row mt-4">                                                          
                                    ...
                                    <div class="col-lg-6">
                                        <div class="col-lg-4">
                                            <button id="btnProcessUpload" onclick="processUpload();" type="button" class="btn btn-success m-0 ms-2"><?php echo app('translator')->get('words.assigntocompany'); ?></button>
                                        </div>
                                    </div>      
...
<?php $__env->startPush('js'); ?>
    ...
    $("#file1").on("change", function() {
        ...
        {
            $('#file1_error').html('<?php echo app('translator')->get('words.pleaseselectbasemapfile'); ?>');
            $('#file1_error').show();
            return;
        }
        else
        {
            $('#file1_error').html('<?php echo app('translator')->get('words.pleaseselectonebasemapfileonly'); ?>');
            $('#file1_error').show();
            return;
        }
        ...
        {
            $('#file1_error').html('<?php echo app('translator')->get('words.invalifilestartwith'); ?>' + "DKS3_" + workOrderName + "_BaseMap");
            $('#file1_error').show();
            return;
        }
    ...
    $("#file3").on("change", function() {
        ...
        {
            $('#file3_error').html('<?php echo app('translator')->get('words.pleaseselectsurveymapfile'); ?>');
            $('#file3_error').show();
            return;
        }
        else
        {
            $('#file3_error').html('<?php echo app('translator')->get('words.pleaseselectonesurveymapfileonly'); ?>');
            $('#file3_error').show();
            return;
        }
        ...
        {
            $('#file3_error').html('<?php echo app('translator')->get('words.invalifilestartwith'); ?>' + "DKS3_" + workOrderName + "_Map_for_Survey");
            $('#file3_error').show();
            return;
        }
    ...
    function processUpload()
    {
        ...
        {
            $('#file3_error').html('<?php echo app('translator')->get('words.pleaseselectsurveyfile'); ?>');
            $('#file3_error').show();
            isError = true;
        }
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Senthil\Hemminger\Dk3app_Final\dk3app\resources\views/laravel/survey/assigntosurvey.blade.php ENDPATH**/ ?>