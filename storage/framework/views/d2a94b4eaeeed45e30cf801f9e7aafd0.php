                            ...
                            <div class="row">
                                <div class="col-6">
                                    ...
                                    <div class="input-group">
                                        <input id="employeename" name="employeename" class="form-control" type="text" placeholder="Employee Name">
                                    </div>
                            ...
                            <div class="row mt-4">
                                <div class="col-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input id="joindate" name="joindate" class="form-control" type="date"
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input id="employee_id" name="employee_id" class="form-control"
                                            ...
                                            type="employee_id" placeholder="Employeeb Id">
        ...
        <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="form-check">
                <input 
                    ...
                    <?php echo e(in_array($role->id, old('role', [])) ? 'checked' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-6">
                                    ...
                                    <label class="form-label mt-4">Blood group</label>

                                    <div class="input-group">

                                        <input id="bloodgroup" name="bloodgroup" class="form-control" type="text"

                                            placeholder="Blood group" value="<?php echo e(old('bloodgroup')); ?>">
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input id="phone" name="phone" class="form-control" type="number"
                                            ...
                                            value="<?php echo e(old('phone')); ?>" placeholder="+40 735 631 620">
...
<?php $__env->startPush('css'); ?>
   ...
   <style>
    .role-checkbox-group {
        ...
        gap: 8px; /* Adds spacing between checkboxes */
    }
...
<script>
    ...
    //         let gender = document.getElementById("choices-gender").value;
    //         let roles = document.querySelectorAll('input[name="role[]"]:checked');
    ...
    //         if (birthday === "") errors.push("Birth Date is required.");
    //         if (bloodgroup === "") errors.push("Blood Group is required.");
    //         if (address === "") errors.push("Address is required.");
    //         if (gender === "") errors.push("Gender is required.");
    //         if (roles.length === 0) errors.push("At least one Role must be selected.");
    ...
    $('#userForm').submit(function (e) {
        ...
        $.ajax({
            url: "<?php echo e(route('saveuser')); ?>", // Laravel route
            type: "POST",
            data: formData,
            processData: false, 
            contentType: false,
            ...
            success: function (response) {
                if (response.success) {
                        Swal.fire({
                            icon: 'success',
                            title: 'Success',
                            text: response.message, // The success message from the response
...
<?php /**PATH C:\xampp\htdocs\Nilatech_attendance\resources\views/laravel/userdetails/create.blade.php ENDPATH**/ ?>