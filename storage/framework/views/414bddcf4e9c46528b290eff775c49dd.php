...
<?php $__env->startSection('content'); ?>
      <nav class="navbar navbar-main navbar-expand-lg px-0 mx-1 shadow-none border-radius-xl mt-2 bg-primary ">
        <div class="container-fluid py-1 px-3">
            <?php echo $__env->make('layouts.navbars.auth.topnav', ['title' => 'Work Order assignment to Data Preparation'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <div class="card mx-1 my-1  mt-1 pt-1" id="basic-info">
		<div class="card-header  mt-1 pt-1">
			<h5>Work Order assignment to Data Preparation</h5>
		</div>
...
unset($__errorArgs, $__bag); ?>
								...
								<div class="row  mt-4">
									<div class="col-lg-2 pt-1 text-end">
										<label class="form-label">Work Duration (in Hours)</label>
									</div>
									<div class="col-lg-6">
										<div class="input-group">
											<input id="inDuration" name="inDuration" class="form-control" type="number" 
												placeholder="Duration" value="0">
										</div>
										<?php $__errorArgs = ['name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
...
unset($__errorArgs, $__bag); ?>
								...
								<div class="row mt-4">															
									...
									<div class="col-lg-6">
										<button id="btnComplete" onclick="btnCompleteClick();" type="button" class="btn btn-success m-0 ms-2">Complete Data Preparation</button>
...
<?php $__env->startPush('js'); ?>
	...
	function processComplete(workOrderId,workDuration)
	{
		...
		$.ajax({
			...
			url: '<?php echo e(route('completeDatapreparationPost')); ?>',
			type: 'post',
			data:fd,
			contentType: false,
			processData: false,
			...
			if (response.success)
			{
				Swal.fire({
							icon: 'success',
							title: 'WorkOrder',
							text: "WorkOrder is updated as completed",
	...
	function btnCompleteClick()
	{
		...
		Swal.fire({
				icon: 'warning',
				title: 'WorkOrder',
				html: "Please confirm to complete Data Preparation.<br>Duration : " + workDuration +"(Hrs)",
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Senthil\DK3\HemmingerUAT\release01_UAT_27042024\dk3app\resources\views/laravel/datapreparation/completedatapreparation.blade.php ENDPATH**/ ?>