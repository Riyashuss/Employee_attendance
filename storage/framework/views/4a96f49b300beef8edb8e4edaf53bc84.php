...
<nav class="navbar navbar-main navbar-expand-lg px-0 mx-1 shadow-none border-radius-xl mt-2 bg-primary ">
        <div class="container-fluid py-1 px-3">
            <?php echo $__env->make('layouts.navbars.auth.topnav', ['title' => trans('words.profile')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            ...
            <div class="col-lg-12">
                ...
                <div class="card" id="basic-info">
                    <div class="card-header">
                        <h5> <?php echo app('translator')->get('words.profile'); ?> </h5>
                    </div>
                    <div class="card-body">
                        <form method="POST" action="">
							...
							<div class="row">
								<div class="col-6 mt-2">
									<label class="form-label"> <?php echo app('translator')->get('words.oldpassword'); ?></label>
...
<?php $__env->startPush('js'); ?>
	...
	if(confirmpassword == "") {
            $('#confirm_password_error').html('<?php echo app('translator')->get('words.cpsnbempt'); ?>');
            $('#confirm_password_error').show();
            isError = true;
        } else if (password !== confirmpassword) {              
            $('#confirm_password_error').html('<?php echo app('translator')->get('words.passwordnotemt'); ?>');
            $('#confirm_password_error').show();
            isError = true;
        }
    // Old password validation
    if(oldpassword === "") {
        $('#old_password_error').html('<?php echo app('translator')->get('words.penteroldpassword'); ?>');
        ...
        $.ajax({
            ...
            success: function(response){
                if (response.success) {
                    Swal.fire({
                        icon: 'success',
                        title: '<?php echo app('translator')->get('words.profile'); ?>',
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Employee_attendance\resources\views/laravel/userwork/profile.blade.php ENDPATH**/ ?>