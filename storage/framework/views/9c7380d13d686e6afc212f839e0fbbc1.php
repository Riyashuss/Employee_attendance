...
<nav class="navbar navbar-main navbar-expand-lg px-0 mx-1 shadow-none border-radius-xl mt-2 bg-primary ">
        <div class="container-fluid py-1 px-3">
            <?php echo $__env->make('layouts.navbars.auth.topnav', ['title' => 'Assign Work Order'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <div class=" mx-1 my-1  mt-1 pt-1">
		...
		<div class="d-flex justify-content-center mt-4">
			<button class="btn btn-icon btn-4 btn-sm btn-success" type="button" id="addButton">
				<span class="btn-inner--icon"><i class="fa fa-user"></i> </span>
				<span class="btn-inner--text ms-1">Assign</span>
			</button>
		</div>
	</div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\dk3app\resources\views/assignorder.blade.php ENDPATH**/ ?>