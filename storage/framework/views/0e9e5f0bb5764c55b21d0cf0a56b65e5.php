<!-- Navbar -->
<nav class="navbar navbar-expand-lg position-absolute <?php echo e($classes); ?>">
    <div class="<?php echo e($container ?? 'container-fluid'); ?> ps-2 pe-0">
        <a class="navbar-brand font-weight-bolder ms-lg-0 ms-3 <?php echo e($text ?? ''); ?>"
            href="/default">
            ...
            <ul class="navbar-nav navbar-nav-hover mx-auto">
                <li class="nav-item dropdown dropdown-hover mx-2">
                    <a role="button"
                        ...
                        Pages
                        <img src="<?php echo e($arrow ?? '/assets/img/down-arrow-dark.svg'); ?>" alt="down-arrow"
                            ...
                            <div class="col-12 px-4 py-2">
                                <div class="row">
                                    <div class="col-4 position-relative">
                                        ...
                                        <a href="<?php echo e(route('users', ['page' => 'reports'])); ?>"
                                            class="dropdown-item border-radius-md">
                                            <span class="ps-3">Reports</span>
                                        </a>
                                        <a href="<?php echo e(route('users', ['page' => 'new-user'])); ?>"
                                            class="dropdown-item border-radius-md">
                                    ...
                                    <div class="col-4 position-relative">
                                        ...
                                        <a href="<?php echo e(route('profiles', ['page' => 'overview'])); ?>"
                                            class="dropdown-item border-radius-md">
                                            <span class="ps-3">Overview</span>
                                        </a>
                                        <a href="<?php echo e(route('profiles', ['page' => 'teams'])); ?>"
                                            class="dropdown-item border-radius-md">
                                            <span class="ps-3">Teams</span>
                                        </a>
                                        <a href="<?php echo e(route('profiles', ['page' => 'projects'])); ?>"
                                            class="dropdown-item border-radius-md">
                                        ...
                                        <a href="<?php echo e(route('projects', ['page' => 'general'])); ?>"
                                            class="dropdown-item border-radius-md">
                                            <span class="ps-3">General</span>
                                        </a>
                                        <a href="<?php echo e(route('projects', ['page' => 'timeline'])); ?>"
                                            class="dropdown-item border-radius-md">
                                            <span class="ps-3">Timeline</span>
                                        </a>
                                        <a href="<?php echo e(route('projects', ['page' => 'new-project'])); ?>"
                                            class="dropdown-item border-radius-md">
                                    ...
                                    <div class="col-4">
                                        ...
                                        <a href="<?php echo e(route('accounts', ['page' => 'settings'])); ?>"
                                            class="dropdown-item border-radius-md">
                                            <span class="ps-3">Settings</span>
                                        </a>
                                        <a href="<?php echo e(route('accounts', ['page' => 'billing'])); ?>"
                                            class="dropdown-item border-radius-md">
                                            <span class="ps-3">Billing</span>
                                        </a>
                                        <a href="<?php echo e(route('accounts', ['page' => 'invoice'])); ?>"
                                            class="dropdown-item border-radius-md">
                                            <span class="ps-3">Invoice</span>
                                        </a>
                                        <a href="<?php echo e(route('accounts', ['page' => 'security'])); ?>"
                                            class="dropdown-item border-radius-md">
                                        ...
                                        <a href="<?php echo e(route('pages', ['page' => 'pricing-page'])); ?>"
                                            class="dropdown-item border-radius-md">
                                            <span class="ps-3">Pricing Page</span>
                                        </a>
                                        <a href="<?php echo e(route('pages', ['page' => 'rtl'])); ?>"
                                            class="dropdown-item border-radius-md">
                                            <span class="ps-3">RTL Page</span>
                                        </a>
                                        <a href="<?php echo e(route('pages', ['page' => 'widgets'])); ?>"
                                            class="dropdown-item border-radius-md">
                    ...
                    <div class="dropdown-menu dropdown-menu-animation dropdown-lg border-radius-xl p-3 mt-0 mt-lg-3 shadow-none"
                                ...
                                <ul class="list-group">
                                    <li
                                        ...
                                        <div class="dropdown-menu mt-0 py-3 px-2"
                                            ...
                                            <a class="dropdown-item ps-3 border-radius-md mb-1"
                                                href="<?php echo e(route('signins', ['page' => 'signin-basic'])); ?>">
                                                <span>Basic</span>
                                            </a>
                                            <a class="dropdown-item ps-3 border-radius-md mb-1"
                                                href="<?php echo e(route('signins', ['page' => 'signin-cover'])); ?>">
                                                <span>Cover</span>
                                            </a>
                                            <a class="dropdown-item ps-3 border-radius-md mb-1"
                                                href="<?php echo e(route('signins', ['page' => 'signin-illustration'])); ?>">
                                    ...
                                    <li
                                        ...
                                        <div class="dropdown-menu mt-0 py-3 px-2"
                                            ...
                                            <a class="dropdown-item ps-3 border-radius-md mb-1"
                                                href="<?php echo e(route('signups', ['page' => 'signup-basic'])); ?>">
                                                <span>Basic</span>
                                            </a>
                                            <a class="dropdown-item ps-3 border-radius-md mb-1"
                                                href="<?php echo e(route('signups', ['page' => 'signup-cover'])); ?>">
                                                <span>Cover</span>
                                            </a>
                                            <a class="dropdown-item ps-3 border-radius-md mb-1"
                                                href="<?php echo e(route('signups', ['page' => 'signup-illustration'])); ?>">
                                                <span>Illustration</span>
                                            </a>
                                        </div>
                                    </li>
                                    <li
                                        ...
                                        <div class="dropdown-menu mt-0 py-3 px-2"
                                            ...
                                            <a class="dropdown-item ps-3 border-radius-md mb-1"
                                                href="<?php echo e(route('resets', ['page' => 'reset-basic'])); ?>">
                                                <span>Basic</span>
                                            </a>
                                            <a class="dropdown-item ps-3 border-radius-md mb-1"
                                                href="<?php echo e(route('resets', ['page' => 'reset-cover'])); ?>">
                                                <span>Cover</span>
                                            </a>
                                            <a class="dropdown-item ps-3 border-radius-md mb-1"
                                                href="<?php echo e(route('resets', ['page' => 'reset-illustration'])); ?>">
                                                <span>Illustration</span>
                                            </a>
                                        </div>
                                    </li>
                                    <li
                                        ...
                                        <div class="dropdown-menu mt-0 py-3 px-2"
                                            ...
                                            <a class="dropdown-item ps-3 border-radius-md mb-1"
                                                href="<?php echo e(route('locks', ['page' => 'lock-basic'])); ?>">
                                                <span>Basic</span>
                                            </a>
                                            <a class="dropdown-item ps-3 border-radius-md mb-1"
                                                href="<?php echo e(route('locks', ['page' => 'lock-cover'])); ?>">
                                                <span>Cover</span>
                                            </a>
                                            <a class="dropdown-item ps-3 border-radius-md mb-1"
                                                href="<?php echo e(route('locks', ['page' => 'lock-illustration'])); ?>">
                                                <span>Illustration</span>
                                            </a>
                                        </div>
                                    </li>
                                    <li
                                        ...
                                        <div class="dropdown-menu mt-0 py-3 px-2"
                                            ...
                                            <a class="dropdown-item ps-3 border-radius-md mb-1"
                                                href="<?php echo e(route('verifications', ['page' => 'verification-basic'])); ?>">
                                                <span>Basic</span>
                                            </a>
                                            <a class="dropdown-item ps-3 border-radius-md mb-1"
                                                href="<?php echo e(route('verifications', ['page' => 'verification-cover'])); ?>">
                                                <span>Cover</span>
                                            </a>
                                            <a class="dropdown-item ps-3 border-radius-md mb-1"
                                                href="<?php echo e(route('verifications', ['page' => 'verification-illustration'])); ?>">
                                                <span>Illustration</span>
                                            </a>
                                        </div>
                                    </li>
                                    <li
                                        ...
                                        <div class="dropdown-menu mt-0 py-3 px-2"
                                            ...
                                            <a class="dropdown-item ps-3 border-radius-md mb-1"
                                                href="<?php echo e(route('errors', ['page' => '404'])); ?>">
                                                <span>404</span>
                                            </a>
                                            <a class="dropdown-item ps-3 border-radius-md mb-1"
                                                href="<?php echo e(route('errors', ['page' => '500'])); ?>">
                                                <span>500</span>
                                            </a>
                                        </div>
                                    </li>
                        ...
                        <div class="row d-lg-none">
                            <div class="col-12 d-flex justify-content-center flex-column">
                                ...
                                <a href="<?php echo e(route('signins', ['page' => 'signin-basic'])); ?>"
                                    class="dropdown-item border-radius-md">
                                    Basic
                                </a>
                                <a href="<?php echo e(route('signins', ['page' => 'signin-cover'])); ?>"
                                    class="dropdown-item border-radius-md">
                                    Cover
                                </a>
                                <a href="<?php echo e(route('signins', ['page' => 'signin-illustration'])); ?>"
                                    class="dropdown-item border-radius-md">
                                    Illustration
                                </a>
                                <h6
                                ...
                                <a href="<?php echo e(route('signups', ['page' => 'signup-basic'])); ?>"
                                    class="dropdown-item border-radius-md">
                                    Basic
                                </a>
                                <a href="<?php echo e(route('signups', ['page' => 'signup-cover'])); ?>"
                                    class="dropdown-item border-radius-md">
                                    Cover
                                </a>
                                <a href="<?php echo e(route('signups', ['page' => 'signup-illustration'])); ?>"
                                    class="dropdown-item border-radius-md">
                                    Illustration
                                </a>
                                <h6
                                ...
                                <a href="<?php echo e(route('resets', ['page' => 'reset-basic'])); ?>"
                                    class="dropdown-item border-radius-md">
                                    Basic
                                </a>
                                <a href="<?php echo e(route('resets', ['page' => 'reset-cover'])); ?>"
                                    class="dropdown-item border-radius-md">
                                    Cover
                                </a>
                                <a href="<?php echo e(route('resets', ['page' => 'reset-illustration'])); ?>"
                                    class="dropdown-item border-radius-md">
                                    Illustation
                                </a>
                                <h6
                                ...
                                <a href="<?php echo e(route('resets', ['page' => 'lock-basic'])); ?>"
                                    class="dropdown-item border-radius-md">
                                    Basic
                                </a>
                                <a href="<?php echo e(route('locks', ['page' => 'lock-cover'])); ?>"
                                    class="dropdown-item border-radius-md">
                                    Cover
                                </a>
                                <a href="<?php echo e(route('locks', ['page' => 'lock-illustration'])); ?>"
                                    class="dropdown-item border-radius-md">
                                    Illustration
                                </a>
                                <h6
                                ...
                                <a href="<?php echo e(route('verifications', ['page' => 'verification-basic'])); ?>"
                                    class="dropdown-item border-radius-md">
                                    Basic
                                </a>
                                <a href="<?php echo e(route('verifications', ['page' => 'verification-cover'])); ?>"
                                    class="dropdown-item border-radius-md">
                                    Cover
                                </a>
                                <a href="<?php echo e(route('verifications', ['page' => 'verification-illustration'])); ?>"
                                    class="dropdown-item border-radius-md">
                                    Illustration
                                </a>
                                <h6
                                ...
                                <a href="<?php echo e(route('errors', ['page' => '404'])); ?>"
                                    class="dropdown-item border-radius-md">
                                    404
                                </a>
                                <a href="<?php echo e(route('errors', ['page' => '500'])); ?>"
                                    class="dropdown-item border-radius-md">
                                    500
                                </a>
                            </div>
                            ...
                            <ul class="list-group">
                                <li
                                    ...
                                    <a class="dropdown-item py-2 ps-3 border-radius-md"
                                        href="<?php echo e(route('applications', ['page' => 'kanban'])); ?>">
                                        <div class="d-flex">
                                ...
                                <li
                                    class="nav-item dropdown dropdown-hover dropdown-subitem list-group-item border-0 p-0">
                                    <a class="dropdown-item py-2 ps-3 border-radius-md"
                                        href="<?php echo e(route('applications', ['page' => 'wizard'])); ?>">
                                        <div class="d-flex">
                                            <div class="icon h-10 me-3 d-flex mt-1">
                                ...
                                <li
                                    class="nav-item dropdown dropdown-hover dropdown-subitem list-group-item border-0 p-0">
                                    <a class="dropdown-item py-2 ps-3 border-radius-md"
                                        href="<?php echo e(route('applications', ['page' => 'datatables'])); ?>">
                                        <div class="d-flex">
                                            <div class="icon h-10 me-3 d-flex mt-1">
                                ...
                                <li
                                    class="nav-item dropdown dropdown-hover dropdown-subitem list-group-item border-0 p-0">
                                    <a class="dropdown-item py-2 ps-3 border-radius-md"
                                        href="<?php echo e(route('applications', ['page' => 'calendar'])); ?>">
                                        <div class="d-flex">
                                            <div class="icon h-10 me-3 d-flex mt-1">
                            ...
                            <div class="col-12 px-4 py-2">
                                <div class="row">
                                    <div class="col-6 position-relative">
                                        ...
                                        <a href="<?php echo e(route('orders', ['page' => 'order-list'])); ?>"
                                            class="dropdown-item border-radius-md">
                                            <span class="ps-3">Order List</span>
                                        </a>
                                        <a href="<?php echo e(route('orders', ['page' => 'details'])); ?>"
                                            class="dropdown-item border-radius-md">
                                        ...
                                        <a href="<?php echo e(route('ecommerce', ['page' => 'overview-ecommerce'])); ?>"
                                            class="dropdown-item border-radius-md">
                                            <span class="ps-3">Overview</span>
                                        </a>
                                        <a href="<?php echo e(route('ecommerce', ['page' => 'referral'])); ?>"
                                            class="dropdown-item border-radius-md">
                                    ...
                                    <div class="col-6 position-relative">
                                        ...
                                        <a href="<?php echo e(route('products', ['page' => 'new-product'])); ?>"
                                            class="dropdown-item border-radius-md">
                                            <span class="ps-3">New Product</span>
                                        </a>
                                        <a href="<?php echo e(route('products', ['page' => 'edit-product'])); ?>"
                                            class="dropdown-item border-radius-md">
                                            <span class="ps-3">Edit Product</span>
                                        </a>
                                        <a href="<?php echo e(route('products', ['page' => 'product-page'])); ?>"
                                            class="dropdown-item border-radius-md">
                                            <span class="ps-3">Product Page</span>
                                        </a>
                                        <a href="<?php echo e(route('products', ['page' => 'product-list'])); ?>"
                                            class="dropdown-item border-radius-md">
...
<!-- End Navbar -->
<?php /**PATH C:\xampp\htdocs\Dk3\resources\views/layouts/navbars/auth/topnav-auth.blade.php ENDPATH**/ ?>